 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ho(_9,w9,"app");var ov=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class H_{constructor(e,n){this.user=n,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}class E9{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,n){e.enqueueRetryable(()=>n(Ft.UNAUTHENTICATED))}shutdown(){}}class I9{constructor(e){this.token=e,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(e,n){this.changeListener=n,e.enqueueRetryable(()=>n(this.token.user))}shutdown(){this.changeListener=null}}class T9{constructor(e){this.t=e,this.currentUser=Ft.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(e,n){Ge(this.o===void 0);let r=this.i;const o=l=>this.i!==r?(r=this.i,n(l)):Promise.resolve();let i=new Tr;this.o=()=>{this.i++,this.currentUser=this.u(),i.resolve(),i=new Tr,e.enqueueRetryable(()=>o(this.currentUser))};const s=()=>{const l=i;e.enqueueRetryable(async()=>{await l.promise,await o(this.currentUser)})},a=l=>{ie("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=l,this.o&&(this.auth.addAuthTokenListener(this.o),s())};this.t.onInit(l=>a(l)),setTimeout(()=>{if(!this.auth){const l=this.t.getImmediate({optional:!0});l?a(l):(ie("FirebaseAuthCredentialsProvider","Auth not yet detected"),i.resolve(),i=new Tr)}},0),s()}getToken(){const e=this.i,n=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(n).then(r=>this.i!==e?(ie("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):r?(Ge(typeof r.accessToken=="string"),new H_(r.accessToken,this.currentUser)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.o&&this.auth.removeAuthTokenListener(this.o),this.o=void 0}u(){const e=this.auth&&this.auth.getUid();return Ge(e===null||typeof e=="string"),new Ft(e)}}class S9{constructor(e,n,r){this.l=e,this.h=n,this.P=r,this.type="FirstParty",this.user=Ft.FIRST_PARTY,this.I=new Map}T(){return this.P?this.P():null}get headers(){this.I.set("X-Goog-AuthUser",this.l);const e=this.T();return e&&this.I.set("Authorization",e),this.h&&this.I.set("X-Goog-Iam-Authorization-Token",this.h),this.I}}class A9{constructor(e,n,r){this.l=e,this.h=n,this.P=r}getToken(){return Promise.resolve(new S9(this.l,this.h,this.P))}start(e,n){e.enqueueRetryable(()=>n(Ft.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class C9{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class x9{constructor(e){this.A=e,this.forceRefresh=!1,this.appCheck=null,this.R=null}start(e,n){Ge(this.o===void 0);const r=i=>{i.error!=null&&ie("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${i.error.message}`);const s=i.token!==this.R;return this.R=i.token,ie("FirebaseAppCheckTokenProvider",`Received ${s?"new":"existing"} token.`),s?n(i.token):Promise.resolve()};this.o=i=>{e.enqueueRetryable(()=>r(i))};const o=i=>{ie("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=i,this.o&&this.appCheck.addTokenListener(this.o)};this.A.onInit(i=>o(i)),setTimeout(()=>{if(!this.appCheck){const i=this.A.getImmediate({optional:!0});i?o(i):ie("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}},0)}getToken(){const e=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(e).then(n=>n?(Ge(typeof n.token=="string"),this.R=n.token,new C9(n.token)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.o&&this.appCheck.removeTokenListener(this.o),this.o=void 0}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qf{constructor(e,n){this.previousValue=e,n&&(n.sequenceNumberHandler=r=>this.ie(r),this.se=r=>n.writeSequenceNumber(r))}ie(e){return this.previousValue=Math.max(e,this.previousValue),this.previousValue}next(){const e=++this.previousValue;return this.se&&this.se(e),e}}Qf.oe=-1;function uu(t){return t==null}function Tc(t){return t===0&&1/t==-1/0}function M9(t){return typeof t=="number"&&Number.isInteger(t)&&!Tc(t)&&t<=Number.MAX_SAFE_INTEGER&&t>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const r3=new dt(he.comparator);function Or(){return r3}const rw=new dt(he.comparator);function Ms(...t){let e=rw;for(const n of t)e=e.insert(n.key,n);return e}function ow(t){let e=rw;return t.forEach((n,r)=>e=e.insert(n,r.overlayedDocument)),e}function jo(){return na()}function iw(){return na()}function na(){return new us(t=>t.toString(),(t,e)=>t.isEqual(e))}const o3=new dt(he.comparator),i3=new Ot(he.comparator);function Ce(...t){let e=i3;for(const n of t)e=e.add(n);return e}const s3=new Ot(Me);function a3(){return s3}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class U3{constructor(e){this.ct=e}}function j3(t){const e=L3({parent:t.parent,structuredQuery:t.structuredQuery});return t.limitType==="LAST"?Sh(e,e.limit,"L"):e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */function mr(t){t=Rr(t,nn);const e=Rr(t.firestore,nl);return r5(vp(e),t._key).then(n=>S5(e,t,n))}class iE extends b5{constructor(e){super(),this.firestore=e}convertBytes(e){return new ts(e)}convertReference(e){const n=this.convertDocumentKey(e,this.firestore._databaseId);return new nn(this.firestore,null,n)}}function I5(t){t=Rr(t,wu);const e=Rr(t.firestore,nl),n=vp(e),r=new iE(e);return v5(t._query),o5(n,t._query).then(o=>new w5(e,r,t,o))}function T5(t,e,n){t=Rr(t,nn);const r=Rr(t.firestore,nl),o=_5(t.converter,e,n);return sE(r,[f5(Jw(r),"setDoc",t._key,o,t.converter!==null,n).toMutation(t._key,Yn.none())])}function Dh(t,e,n,...r){t=Rr(t,nn);const o=Rr(t.firestore,nl),i=Jw(o);let s;return s=typeof(e=Tt(e))=="string"||e instanceof Eu?m5(i,"updateDoc",t._key,e,n,r):p5(i,"updateDoc",t._key,e),sE(o,[s.toMutation(t._key,Yn.exists(!0))])}function sE(t,e){return function(r,o){const i=new Tr;return r.asyncQueue.enqueueAndForget(async()=>WN(await n5(r),o,i)),i.promise}(vp(t),e)}function S5(t,e,n){const r=n.docs.get(e._key),o=new iE(t);return new oE(t,o,e._key,r,new Fs(n.hasPendingWrites,n.fromCache),e.converter)}(function(e,n=!0){(function(o){cs=o})(is),Ki(new Xo("firestore",(r,{instanceIdentifier:o,options:i})=>{const s=r.getProvider("app").getImmediate(),a=new nl(new T9(r.getProvider("auth-internal")),new x9(r.getProvider("app-check-internal")),function(u,d){if(!Object.prototype.hasOwnProperty.apply(u.options,["projectId"]))throw new le(B.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Na(u.options.projectId,d)}(s,o),s);return i=Object.assign({useFetchStreams:n},i),a._setSettings(i),a},"PUBLIC").setMultipleInstances(!0)),ho(iv,"4.7.3",e),ho(iv,"4.7.3","esm2017")})();const A5={apiKey:"AIzaSyA8jYL0_YD1f8lxP4Sv9RXbXckYcB3zUzw",authDomain:"mtc-database-7a3f4.firebaseapp.com",projectId:"mtc-database-7a3f4",storageBucket:"mtc-database-7a3f4.appspot.com",messagingSenderId:"210230014480",appId:"1:210230014480:web:a1d2942088a3e35accd095"},aE=O1(A5),je=jf(aE),_r=l5(aE),jv=navigator.onLine,Bv="https://teachablemachine.withgoogle.com/models/vkbx0yK3Q/";let Lo=!0,Ed,vn,Id,Td,gi;const C5={data(){return{showPage:!0,startButton:!1,stopButton:!0}},beforeMounted(){window.addEventListener("load",()=>{jv||alert(`No network detected 
 ...
 Enter the last 4 digits of your matric number to login`,"0123")==u?a.data().verification=="verified"?(t.dispatch("anonSignin",a.data().name),Lo=!1,vn.stop()):(Lo=!1,vn.stop(),alert("User not verified! Contact Admin."),Ee.push("/")):(Lo=!1,vn.stop(),alert("Wrong User detected!"),Ee.push("/"))}else console.log("Name does not exist")})}}e()},methods:{toggleShowProductPage(){vn.stop(),Lo=!1,Ee.push("/")},stopVid(){vn.stop(),Lo=!1,this.startButton=!0,this.stopButton=!1}}},x5={class:"fixed outline-none flex flex-col bottom-0 h-full w-full bg-black z-40 bg-opacity-30 text-slate-800"},P5={class:"flex flex-col h-5/6 rounded-xl m-auto pt-2 pb-5 w-wd9 md:w-wd7 lg:w-wd45 xl:w-wd45 overflow-x-hidden overflow-y-auto overflow-hidden bg-slate-100 shadow-sm"},k5={class:"mx-auto text-center space-y-3"},O5={class:"w-full flex justify-evenly md:justify-between mt-10 text-sm font-normal md:font-semibold border-red-500 md:mx-auto md:w-3/4"};function R5(t,e,n,r,o,i){const s=ke("font-awesome-icon"),a=ke("router-link");return j(),ze(os,{name:"slide-fade"},{default:et(()=>[ut(x("div",x5,[x("div",{onClick:e[0]||(e[0]=l=>i.toggleShowProductPage()),class:"z-50 mx-auto mt-6 -mb-5 w-8 h-8 md:w-12 md:h-12 shadow-md cursor-pointer p-2 hover:bg-slate-300 transition-all rounded-full flex bg-gray-100"},[ue(s,{icon:"fa-solid fa-x",size:"sm",style:{color:"#333366"},class:"md:hidden m-auto rounded-full"}),ue(s,{icon:"fa-solid fa-x",size:"lg",style:{color:"#333366"},class:"hidden md:block m-auto rounded-full"})]),x("div",P5,[e[7]||(e[7]=x("div",{class:"flex z-50 my-auto md:py-2 w-full h-full"},[x("div",{class:"m-auto border-blue-400 flex-col py-10 px-4 space-y-10 md:space-y-5"},[x("div",{id:"webcam-container",class:"rounded-full w-fit h-fit -scroll-my-10 mx-auto overflow-hidden border-2 border-purple-700"}),x("div",{class:"flex w-full space-x-5 mx-auto"},[x("div",{id:"label-container",class:"rounded-xl text-sm md:text-base"},"Please wait while the system load...")])])],-1)),x("div",k5,[e[4]||(e[4]=x("p",null,"Wrong Face detected?",-1)),x("p",null,[ue(a,{to:"/manualLogin",onClick:e[1]||(e[1]=l=>i.stopVid()),class:"bg-purple-900 text-slate-200 px-6 py-1 hover:px-7 hover:py-2 rounded-lg transition-all shadow-lg"},{default:et(()=>e[3]||(e[3]=[it(" Manual LogIn")])),_:1})])]),x("div",O5,[e[6]||(e[6]=x("p",{class:"text-center my-auto"},"New to the system? Proceed to ",-1)),ue(a,{to:"/Signup",onClick:e[2]||(e[2]=l=>i.stopVid()),class:"bg-purple-900 text-slate-200 my-auto px-2 py-1 hover:px-7 hover:py-2 rounded-lg transition-all shadow-lg"},{default:et(()=>e[5]||(e[5]=[it(" Sign Up")])),_:1})])])],512),[[Ba,o.showPage]])]),_:1})}const N5=on(C5,[["render",R5]]),L5={components:{camPage:N5}};function D5(t,e,n,r,o,i){const s=ke("camPage");return j(),ne("div",null,[ue(s)])}const V5=on(L5,[["render",D5]]),M5={data(){return{showEye:!0,levelOptions:[{label:"ND 1",value:"nd1"},{label:"ND 2",value:"nd2"},{label:"HND 1",value:"hnd1"},{label:"HND 2",value:"hnd2"}],genderOptions:[{label:"Male",value:"male"},{label:"Female",value:"female"}]}},methods:{eyes(){this.showEye=!this.showEye}},setup(){const t=Er({}),e=ri(),n=Xx(),r=Er(),o=[{label:"Computer Science",value:"computer science"},{label:"Science Laboratory Technology",value:"slt"},{label:"Engineering",value:"engineering"},{label:"Law",value:"law"},{label:"Tourism",value:"tourism"},{label:"Agriculture",value:"agriculture"},{label:"Pharmacy",value:"pharmacy"},{label:"Banking and Finance",value:"banking and finance"},{label:"Education",value:"education"},{label:"Mass Communication",value:"mass communication"},{label:"Business Administration",value:"Business Administration"},{label:"Food Technology",value:"food technology"},{label:"Glass Technology",value:"glass technology"},{label:"Accounting",value:"accounting"},{label:"Taxation",value:"taxation"},{label:"Fisheries",value:"fisheries"},{label:"Civil Engineering",value:"civil engineering"},{label:"Mechanical Engineering",value:"mechanical engineering"},{label:"Electrical Engineering",value:"electrical engineering"},{label:"Estate Management",value:"estate management"},{label:"Statistics",value:"statistics"},{label:"Art and industrial Design",value:"art and industrial design"},{label:"Marketing",value:"marketing"},{label:"Architectural Technology",value:"architectural technology"}],i=()=>{navigator.vibrate([100,50])};return{registerForm:t,showPassword:()=>{const l=document.getElementById("password"),u=document.getElementById("password2");l.type==="password"&&u.type==="password"?(l.type="text",u.type="text"):(l.type="password",u.type="password")},register:()=>{var l=document.getElementById("password"),u=document.getElementById("password2");l.value!=""&&u.value!=""&&(l.value===u.value?e.dispatch("register",t.value):(i(),n.add({severity:"error",summary:"Error!",detail:"Passwords not matched",life:3e3})))},departmentOptions:o,department:r}}},$5={class:"w-full h-full absolute flex"},F5={class:"h-fit m-auto px-2 flex flex-col-reverse rounded-lg md:flex-row w-11/12 md:w-2/3 py-10 bg-slate-50 shadow-2xl"},U5={class:"flex z-50 md:py-2 w-full h-full"},j5={class:"w-full h-full py-2 flex flex-col px-2 md:h-full m-auto md:m-0"},B5={class:"w-full h-full space-y-2 flex flex-col md:space-y-3"},z5={class:"flex flex-col space-y-3 md:flex-col text-sm md:text-base"},H5=["value"],K5=["value"],W5=["value"],q5={class:"bg-inherit m-auto w-11/12 md:m-auto md:w-full lg:w-3/4 lg:m-auto border-b-2 flex border-slate-400"},G5={class:"w-full flex justify-evenly md:justify-between mt-10 font-semibold border-red-500 md:mx-auto md:w-2/4"};function Q5(t,e,n,r,o,i){const s=ke("font-awesome-icon"),a=ke("router-link");return j(),ne("div",$5,[x("div",F5,[x("div",U5,[x("div",j5,[e[26]||(e[26]=x("img",{src:ls,alt:"Fpa logo",class:"w-16 -mt-2 md:w-28 md:m-auto mx-auto"},null,-1)),x("div",B5,[e[22]||(e[22]=x("h2",{class:"text-slate-800 mx-auto font-bold text-lg uppercase"},"Sign up",-1)),e[23]||(e[23]=x("h4",{class:"text-slate-800 font-bold text-sm md:text-base text-center"},"Enter your details below to signup.",-1)),x("form",{name:"emailAndPassword",onSubmit:e[10]||(e[10]=bf(l=>r.register(),["prevent"])),class:"flex flex-col space-y-3"},[x("div",z5,[e[11]||(e[11]=x("label",{for:"name",class:"bg-inherit mx-auto -yb-10 w-11/12 md:w-full lg:w-3/4 lg:mx-auto indent-1 font-bold"},"Enter Full Name:",-1)),ut(x("input",{name:"DisplayName",type:"text","onUpdate:modelValue":e[0]||(e[0]=l=>r.registerForm.name=l),placeholder:"Adigun Chibike Hassan",class:"bg-inherit m-auto py-2 w-11/12 md:w-full lg:w-3/4 lg:mx-auto indent-1 font-semibold border-b-2 border-slate-400"},null,512),[[fr,r.registerForm.name,void 0,{trim:!0,lazy:!0}]]),e[12]||(e[12]=x("label",{for:"DOB",class:"bg-inherit mx-auto -yb-10 w-11/12 md:w-full lg:w-3/4 lg:mx-auto indent-1 font-semibold"},"Date of Birth:",-1)),ut(x("input",{name:"Age",type:"date","onUpdate:modelValue":e[1]||(e[1]=l=>r.registerForm.age=l),class:"bg-inherit m-auto py-2 w-11/12 md:w-full lg:w-3/4 lg:mx-auto indent-1 font-semibold border-b-2 border-slate-400"},null,512),[[fr,r.registerForm.age,void 0,{trim:!0,lazy:!0}]]),e[13]||(e[13]=x("label",{for:"Email",class:"bg-inherit mx-auto -yb-10 w-11/12 md:w-full lg:w-3/4 lg:mx-auto indent-1 font-bold"},"Enter Email Address:",-1)),ut(x("input",{name:"Email",type:"email","onUpdate:modelValue":e[2]||(e[2]=l=>r.registerForm.email=l),placeholder:"Johndeo@gmail.com",class:"bg-inherit m-auto py-2 w-11/12 md:w-full lg:w-3/4 lg:mx-auto indent-1 font-semibold border-b-2 border-slate-400"},null,512),[[fr,r.registerForm.email,void 0,{trim:!0,lazy:!0}]]),e[14]||(e[14]=x("label",{for:"department",class:"bg-inherit m-auto py-2 w-11/12 md:w-full lg:w-3/4 lg:mx-auto indent-1 font-bold"},"Select Your Department.",-1)),ut(x("select",{name:"department","onUpdate:modelValue":e[3]||(e[3]=l=>r.registerForm.department=l),class:"bg-inherit m-auto py-2 w-11/12 md:w-full lg:w-3/4 lg:mx-auto indent-1 font-semibold border-b-2 border-slate-400"},[(j(!0),ne(qe,null,Rn(r.departmentOptions,l=>(j(),ne("option",{key:l.label,value:l.value},Oe(l.label),9,H5))),128))],512),[[Gs,r.registerForm.department]]),e[15]||(e[15]=x("label",{for:"level",class:"bg-inherit mx-auto -yb-10 w-11/12 md:w-full lg:w-3/4 lg:mx-auto indent-1 font-bold"}," Select Your Level. ",-1)),ut(x("select",{name:"level","onUpdate:modelValue":e[4]||(e[4]=l=>r.registerForm.level=l),class:"bg-inherit m-auto py-2 w-11/12 md:w-full lg:w-3/4 lg:mx-auto indent-1 font-semibold border-b-2 border-slate-400"},[(j(!0),ne(qe,null,Rn(o.levelOptions,l=>(j(),ne("option",{key:l.label,value:l.value},Oe(l.label),9,K5))),128))],512),[[Gs,r.registerForm.level]]),e[16]||(e[16]=x("label",{for:"gender",class:"bg-inherit mx-auto -yb-10 w-11/12 md:w-full lg:w-3/4 lg:mx-auto indent-1 font-bold"},"Select Your Gender.",-1)),ut(x("select",{name:"gender","onUpdate:modelValue":e[5]||(e[5]=l=>r.registerForm.gender=l),class:"bg-inherit m-auto py-2 w-11/12 md:w-full lg:w-3/4 lg:mx-auto indent-1 font-semibold border-b-2 border-slate-400"},[(j(!0),ne(qe,null,Rn(o.genderOptions,l=>(j(),ne("option",{key:l.label,value:l.value},Oe(l.label),9,W5))),128))],512),[[Gs,r.registerForm.gender]]),e[17]||(e[17]=x("label",{for:"matric",class:"bg-inherit mx-auto -yb-10 w-11/12 md:w-full lg:w-3/4 lg:mx-auto indent-1 font-bold"},"Enter Matric Number:",-1)),ut(x("input",{name:"matric",type:"text","onUpdate:modelValue":e[6]||(e[6]=l=>r.registerForm.matric=l),placeholder:"fpa/cs/19/2-0000",class:"bg-inherit m-auto py-2 w-11/12 md:w-full lg:w-3/4 lg:mx-auto indent-1 font-semibold border-b-2 border-slate-400"},null,512),[[fr,r.registerForm.matric,void 0,{trim:!0,lazy:!0}]]),e[18]||(e[18]=x("label",{for:"password",class:"bg-inherit mx-auto -yb-10 w-11/12 md:w-full lg:w-3/4 lg:mx-auto indent-1 font-bold"},"Enter Password:",-1)),x("div",q5,[ut(x("input",{id:"password",type:"password","onUpdate:modelValue":e[7]||(e[7]=l=>r.registerForm.password=l),class:"bg-inherit m-auto py-2 w-11/12 indent-1 font-semibold"},null,512),[[fr,r.registerForm.password,void 0,{trim:!0,lazy:!0}]]),o.showEye?(j(),ze(s,{key:0,icon:"fa-solid fa-eye",onClick:e[8]||(e[8]=l=>(r.showPassword(),i.eyes())),class:"p-1 m-auto md:p-2 -mr-0 text-gray-600 border-2 rounded-md border-slate-400"})):(j(),ze(s,{key:1,icon:"fa-solid fa-eye-slash",onClick:e[9]||(e[9]=l=>(r.showPassword(),i.eyes())),class:"p-1 m-auto md:p-2 -mr-0 text-gray-600 border-2 rounded-md border-slate-400"}))]),e[19]||(e[19]=x("label",{for:"password",class:"bg-inherit mx-auto -mb-10 w-11/12 md:w-full lg:w-3/4 lg:mx-auto indent-1 font-bold"}," Confirm Password: ",-1)),e[20]||(e[20]=x("input",{id:"password2",type:"password",placeholder:"Confirm password",class:"bg-inherit m-auto text-xs md:text-sm py-2 w-11/12 md:w-full lg:w-3/4 lg:mx-auto indent-1 font-semibold border-b-2 border-slate-400"},null,-1))]),e[21]||(e[21]=x("input",{type:"submit",value:"submit",class:"bg-purple-900 font-bold text-slate-200 mx-auto w-fit px-6 py-1 hover:px-7 hover:py-2 rounded-lg transition-all shadow-lg"},null,-1))],32)]),x("div",G5,[e[25]||(e[25]=x("p",{class:"text-center text-sm md:text-base my-auto"},"Already verified? Proceed to ",-1)),ue(a,{to:"/login",class:"bg-purple-900 text-slate-200 px-2 py-1 hover:px-7 hover:py-2 rounded-lg transition-all shadow-lg"},{default:et(()=>e[24]||(e[24]=[it(" Log In")])),_:1})])])])])])}const Y5=on(M5,[["render",Q5]]),X5={data(){return{userName:"waiting..."}},beforeMount(){this.fetchUserName()},methods:{logout(){this.$store.dispatch("logOut")},fetchUserName(){const t=ri();je.onAuthStateChanged(e=>{e&&(t.state.user==null?this.userName=localStorage.getItem("user"):this.userName=t.state.user)})}}},J5={class:"flex justify-between text-xs mt-2 font-semibold bg-slate-200 border-red-500 px-1 md:px-4 md:w-wd8 md:mx-auto md:py-2 md:text-base rounded-lg"},Z5={class:"flex justify-between py-2 w-full text-center h-fit border-blue-500 my-auto"},eL={class:"bg-purple-500 rounded-lg p-2 md:px-4 mx-1 shadow-lg"},tL={class:"font-bold"};function nL(t,e,n,r,o,i){return j(),ne("div",J5,[x("div",Z5,[x("p",eL,[e[1]||(e[1]=it("User: ")),x("span",tL,Oe(o.userName),1),e[2]||(e[2]=it("."))]),x("p",{class:"bg-purple-500 rounded-lg p-2 md:px-4 mx-1 shadow-lg cursor-pointer",onClick:e[0]||(e[0]=s=>i.logout())}," Logout")])])}const Su=on(X5,[["render",nL]]),rL={components:{headerComponent:Su},data(){return{userName:""}},mounted(){je.onAuthStateChanged(t=>{t&&(this.$store.state.user==null?this.userName=localStorage.getItem("user"):this.$store.state.user=="admin"?Ee.push("/admin"):this.userName=this.$store.state.user)})}},oL={class:"w-full h-full absolute flex flex-col border-red-500"},iL={class:"flex flex-col h-5/6 rounded-xl m-auto pt-2 pb-5 w-wd9 md:w-wd7 lg:w-wd45 xl:w-wd45 bg-slate-100 shadow-sm"},sL={class:"flex z-50 my-auto md:py-2 w-full h-full"},aL={class:"w-full h-fit py-2 flex flex-col px-2 m-auto space-y-10"},lL={class:"w-full space-y-2 flex flex-col"},cL={class:"text-slate-800 mx-auto font-bold text-lg md:text-2xl"},uL={class:"w-full flex justify-evenly md:justify-between font-semibold border-red-500 md:mx-auto md:w-2/4"};function dL(t,e,n,r,o,i){const s=ke("header-component"),a=ke("router-link");return j(),ne("div",oL,[ue(s),x("div",iL,[x("div",sL,[x("div",aL,[e[3]||(e[3]=x("img",{src:ls,alt:"Fpa logo",class:"w-16 -mt-2 md:w-28 my-auto mx-auto"},null,-1)),x("div",lL,[x("h2",cL,"Welcome "+Oe(o.userName),1),e[0]||(e[0]=x("h4",{class:"text-slate-800 font-bold text-xs md:text-lg text-center"},"Choose an option below to take the exam or check you score.",-1))]),x("div",uL,[ue(a,{to:"/examPage",class:"bg-purple-900 text-slate-200 px-2 py-1 hover:px-7 hover:py-2 rounded-lg transition-all shadow-lg"},{default:et(()=>e[1]||(e[1]=[it(" Start Exam")])),_:1}),ue(a,{to:"/scorePage",class:"bg-purple-900 text-slate-200 px-2 py-1 hover:px-7 hover:py-2 rounded-lg transition-all shadow-lg"},{default:et(()=>e[2]||(e[2]=[it(" Check Score")])),_:1})])])])])])}const hL=on(rL,[["render",dL]]);var fL=(t,e)=>{const n=t.__vccOpts||t;for(const[r,o]of e)n[r]=o;return n};const pL={name:"FulfillingBouncingCircleSpinner",props:{animationDuration:{type:Number,default:4e3},size:{type:Number,default:60},color:{type:String,default:"#fff"}},computed:{spinnerStyle(){return{height:`${this.size}px`,width:`${this.size}px`,animationDuration:`${this.animationDuration}ms`}},orbitStyle(){return{height:`${this.size}px`,width:`${this.size}px`,borderColor:this.color,borderWidth:`${this.size*.03}px`,animationDuration:`${this.animationDuration}ms`}},circleStyle(){return{height:`${this.size}px`,width:`${this.size}px`,borderColor:this.color,color:this.color,borderWidth:`${this.size*.1}px`,animationDuration:`${this.animationDuration}ms`}}}};function mL(t,e,n,r,o,i){return j(),ne("div",{class:"fulfilling-bouncing-circle-spinner",style:Ho(i.spinnerStyle)},[x("div",{class:"circle",style:Ho(i.circleStyle)},null,4),x("div",{class:"orbit",style:Ho(i.orbitStyle)},null,4)],4)}var gL=fL(pL,[["render",mL]]);const yL={components:{FulfillingBouncingCircleSpinner:gL,headerComponent:Su},computed:{formattedTime(){const t=Math.floor(this.time/60),e=this.time%60;return`${t.toString().padStart(2,"0")}:${e.toString().padStart(2,"0")}`}},data(){return{time:600,selectedAnswers:{},answers:[]}},mounted(){this.startTimer()},beforeUnmounted(){this.stopTimer()},methods:{startTimer(){this.timer=setInterval(()=>{this.time>0?this.time--:(this.stopTimer(),this.handleTimerEnd())},1e3)},stopTimer(){clearInterval(this.timer),this.timer=null},handleTimerEnd(){Ee.push("/scorePage")},submit(){if(confirm("Are you ready to submit answers?")){for(const[t,e]of Object.entries(this.selectedAnswers))this.answers.push(e);this.$store.dispatch("submitQuiz",this.answers),this.selectedAnswers={},this.answers=[],Ee.push("/confirmScore")}else return}}},vL={class:"w-fit border-red-500 mx-auto"},bL={class:"bg-slate-200 flex justify-between my-2 border-black px-2 md:px-8 md:w-wd8 md:mx-auto md:text-base rounded-lg"},_L={class:"cursor-pointer bg-cyan-600 rounded-xl space-x-2 w-fit text-center flex px-2 md:px-4 py-2 my-2 text-xs font-semibold shadow-lg md:text-base"},wL={class:"py-1"},EL={class:"mx-auto"},IL={class:"w-98 flex flex-col mt-5 mb-10 text-xs md:lg capitalize rounded-xl shadow-black shadow-lg -shadow-lg"},TL={class:"h-fitm px-2 md:px-10 w-full flex flex-wrap border-red-500"},SL={class:"text-base font-bold md:text-lg"},AL=["name","onUpdate:modelValue","value"],CL={for:"options",class:"my-auto ml-2 text-base"};function xL(t,e,n,r,o,i){const s=ke("header-component"),a=ke("fulfilling-bouncing-circle-spinner");return j(),ne("div",vL,[ue(s),x("div",bL,[e[1]||(e[1]=x("h2",{class:"py-2 text-base font-semibold md:text-2xl my-auto"},"Course Code: GNS 501",-1)),x("div",_L,[ue(a,{class:"m-auto block md:hidden","animation-duration":4e3,size:15,color:"#ff1d5e"}),ue(a,{class:"m-auto hidden md:block","animation-duration":4e3,size:20,color:"#ff1d5e"}),x("p",wL,"Time : "+Oe(i.formattedTime),1)])]),x("div",EL,[x("div",IL,[e[2]||(e[2]=x("div",{class:"text-lg font-bold text-center underline py-2"},"Answer the following questions",-1)),x("div",TL,[(j(!0),ne(qe,null,Rn(this.$store.state.questions,(l,u)=>(j(),ne("div",{key:u,class:"my-3 h-fit w-1/2 lg:w-1/3 border-red-500"},[x("h3",SL,"("+Oe(u+1)+") "+Oe(l.questionDetails.question),1),(j(!0),ne(qe,null,Rn(l.questionDetails.options,d=>(j(),ne("div",{key:d,class:"my-2 ml-5 flex"},[ut(x("input",{type:"radio",name:l.questionDetails.name,"onUpdate:modelValue":f=>o.selectedAnswers[l.questionDetails.name]=f,value:d,id:"",required:""},null,8,AL),[[HA,o.selectedAnswers[l.questionDetails.name]]]),x("label",CL,Oe(d),1)]))),128))]))),128))]),x("button",{onClick:e[0]||(e[0]=l=>i.submit()),class:"w-11/12 my-4 mx-auto text-base md:text-lg font-bold bg-purple-900 py-5 text-slate-200 md:w-3/4 md:mx-auto rounded-xl shadow-lg"},"Submit")])])])}const PL=on(yL,[["render",xL]]),kL={components:{headerComponent:Su},data(){return{userName:"",score:"No score yet."}},beforeMount(){this.fetchData()},methods:{async fetchData(){if(this.$store.state.user==null){this.userName=localStorage.getItem("user");const t=lo(_r,"users",this.userName);await mr(t).then(e=>{e.exists()?this.score=e.data().score:this.score="No score yet. Take Exam."})}else{this.userName=this.$store.state.user;const t=lo(_r,"users",this.userName);await mr(t).then(e=>{e.exists()?this.score=e.data().score:this.score="No score yet. Go back and take the test."})}}}},OL={class:"w-full h-full absolute flex flex-col"},RL={class:"flex flex-col h-5/6 rounded-xl m-auto pt-2 pb-5 w-wd9 md:w-wd7 lg:w-wd45 xl:w-wd45 bg-slate-100 shadow-sm"},NL={class:"flex z-50 my-auto md:py-2 w-full h-full"},LL={class:"w-full h-fit py-2 flex flex-col px-2 m-auto space-y-10"},DL={class:"w-full space-y-2 flex flex-col"},VL={class:"text-slate-800 mx-auto font-bold text-lg md:text-2xl"},ML={class:"text-slate-800 font-bold text-xs md:text-lg text-center"},$L={class:"bg-purple-900 text-slate-200 px-2 py-1 rounded-lg transition-all shadow-lg"},FL={class:"w-full flex justify-evenly md:justify-between font-semibold border-red-500 md:mx-auto md:w-2/4"};function UL(t,e,n,r,o,i){const s=ke("header-component"),a=ke("router-link");return j(),ne("div",OL,[ue(s),x("div",RL,[x("div",NL,[x("div",LL,[e[2]||(e[2]=x("img",{src:ls,alt:"Fpa logo",class:"w-16 -mt-2 md:w-28 my-auto mx-auto"},null,-1)),x("div",DL,[x("h2",VL,"Welcome "+Oe(o.userName),1),x("h4",ML,[e[0]||(e[0]=it("Your Total Score is: ")),x("span",$L,Oe(o.score),1)])]),x("div",FL,[ue(a,{to:"/home",class:"bg-purple-900 text-slate-200 mx-auto px-2 py-1 hover:px-7 hover:py-2 rounded-lg transition-all shadow-lg"},{default:et(()=>e[1]||(e[1]=[it("Go Back")])),_:1})])])])])])}const jL=on(kL,[["render",UL]]),BL={data(){return{timer:20}},mounted(){setInterval(()=>{this.timer=this.timer-1},1e3),setTimeout(()=>{this.$store.dispatch("logOut"),Ee.push("/")},21e3)},unmounted(){clearInterval(),clearTimeout()},setup(){let t=!0;const e=ri();return{toggleShowProductPage:()=>{e.dispatch("logOut"),Ee.push("/")},showPage:t}}},zL={class:"fixed outline-none flex flex-col bottom-0 h-full w-full bg-black z-40 bg-opacity-30 text-slate-800"},HL={class:"flex flex-col h-5/6 rounded-xl m-auto pt-2 pb-5 w-wd9 md:w-wd7 lg:w-wd45 xl:w-wd45 overflow-x-hidden overflow-y-auto overflow-hidden bg-slate-100 shadow-sm"},KL={class:"flex z-50 my-auto md:py-2 w-full h-full"},WL={class:"m-auto flex flex-col space-y-2 md:space-y-5"},qL={class:"mt-10 mx-auto text-blue-500 font-semibold underline"},GL={class:"font-semibold text-base text-center"},QL={class:"font-extrabold text-lg"};function YL(t,e,n,r,o,i){const s=ke("font-awesome-icon"),a=ke("router-link");return j(),ze(os,{name:"slide-fade"},{default:et(()=>[ut(x("div",zL,[x("div",{onClick:e[0]||(e[0]=l=>r.toggleShowProductPage()),class:"z-50 mx-auto mt-6 -mb-5 w-8 h-8 md:w-12 md:h-12 shadow-md cursor-pointer p-2 hover:bg-slate-300 transition-all rounded-full flex bg-gray-100"},[ue(s,{icon:"fa-solid fa-x",size:"sm",style:{color:"#333366"},class:"md:hidden m-auto rounded-full"}),ue(s,{icon:"fa-solid fa-x",size:"lg",style:{color:"#333366"},class:"hidden md:block m-auto rounded-full"})]),x("div",HL,[x("div",KL,[x("div",WL,[e[8]||(e[8]=x("div",{class:"md:hidden"},[x("svg",{class:"checkmark m-auto",xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 52 52"},[x("circle",{class:"checkmark__circle",cx:"26",cy:"26",r:"25",fill:"none"}),x("path",{class:"checkmark__check",fill:"none",d:"M14.1 27.2l7.1 7.2 16.7-16.8"})])],-1)),e[9]||(e[9]=x("div",{class:"animation-ctn m-auto hidden md:flex"},[x("div",{class:"icon icon--order-success svg"},[x("svg",{xmlns:"http://www.w3.org/2000/svg",width:"154px",height:"154px"},[x("g",{fill:"none",stroke:"#22AE73","stroke-width":"2"},[x("circle",{cx:"77",cy:"77",r:"72",style:{"stroke-dasharray":"480px, 480px","stroke-dashoffset":"960px"}}),x("circle",{id:"colored",fill:"#22AE73",cx:"77",cy:"77",r:"72",style:{"stroke-dasharray":"480px, 480px","stroke-dashoffset":"960px"}}),x("polyline",{class:"st0",stroke:"#fff","stroke-width":"10",points:"43.5,77.8 63.7,97.9 112.2,49.4 ",style:{"stroke-dasharray":"100px, 100px","stroke-dashoffset":"200px"}})])])])],-1)),e[10]||(e[10]=x("h2",{class:"font-bold text-base mx-auto md:text-lg"},"Details Registered Successfully!",-1)),x("div",qL,[ue(a,{to:"/",onClick:e[1]||(e[1]=l=>r.toggleShowProductPage())},{default:et(()=>e[2]||(e[2]=[it(" Go to Home Page.")])),_:1})]),x("h1",GL,[e[3]||(e[3]=it(" Await further instructions for face capturing to complete registration. ")),e[4]||(e[4]=x("br",null,null,-1)),e[5]||(e[5]=x("br",null,null,-1)),e[6]||(e[6]=it(" You will be rediected to Home Page in : ")),x("span",QL,Oe(o.timer),1),e[7]||(e[7]=it(" seconds. "))])])])])],512),[[Ba,r.showPage]])]),_:1})}const XL=on(BL,[["render",YL],["__scopeId","data-v-3400db96"]]),JL={data(){return{timer:20}},mounted(){setInterval(()=>{this.timer=this.timer-1},1e3),setTimeout(()=>{Ee.push("/home")},21e3)},unmounted(){clearInterval(),clearTimeout()},setup(){return{toggleShowProductPage:()=>{Ee.push("/home")},showPage:!0}}},ZL={class:"fixed outline-none flex flex-col bottom-0 h-full w-full bg-black z-40 bg-opacity-30 text-slate-800"},eD={class:"flex flex-col h-5/6 rounded-xl m-auto pt-2 pb-5 w-wd9 md:w-wd7 lg:w-wd45 xl:w-wd45 overflow-x-hidden overflow-y-auto overflow-hidden bg-slate-100 shadow-sm"},tD={class:"flex z-50 my-auto md:py-2 w-full h-full"},nD={class:"m-auto flex flex-col space-y-2 md:space-y-5"},rD={class:"mt-10 mx-auto text-blue-500 font-semibold underline"},oD={class:"text-center"},iD={class:"font-extrabold text-lg"};function sD(t,e,n,r,o,i){const s=ke("font-awesome-icon"),a=ke("router-link");return j(),ze(os,{name:"slide-fade"},{default:et(()=>[ut(x("div",ZL,[x("div",{onClick:e[0]||(e[0]=l=>r.toggleShowProductPage()),class:"z-50 mx-auto mt-6 -mb-5 w-8 h-8 md:w-12 md:h-12 shadow-md cursor-pointer p-2 hover:bg-slate-300 transition-all rounded-full flex bg-gray-100"},[ue(s,{icon:"fa-solid fa-x",size:"sm",style:{color:"#333366"},class:"md:hidden m-auto rounded-full"}),ue(s,{icon:"fa-solid fa-x",size:"lg",style:{color:"#333366"},class:"hidden md:block m-auto rounded-full"})]),x("div",eD,[x("div",tD,[x("div",nD,[e[4]||(e[4]=x("div",{class:"md:hidden"},[x("svg",{class:"checkmark m-auto",xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 52 52"},[x("circle",{class:"checkmark__circle",cx:"26",cy:"26",r:"25",fill:"none"}),x("path",{class:"checkmark__check",fill:"none",d:"M14.1 27.2l7.1 7.2 16.7-16.8"})])],-1)),e[5]||(e[5]=x("div",{class:"animation-ctn m-auto hidden md:flex"},[x("div",{class:"icon icon--order-success svg"},[x("svg",{xmlns:"http://www.w3.org/2000/svg",width:"154px",height:"154px"},[x("g",{fill:"none",stroke:"#22AE73","stroke-width":"2"},[x("circle",{cx:"77",cy:"77",r:"72",style:{"stroke-dasharray":"480px, 480px","stroke-dashoffset":"960px"}}),x("circle",{id:"colored",fill:"#22AE73",cx:"77",cy:"77",r:"72",style:{"stroke-dasharray":"480px, 480px","stroke-dashoffset":"960px"}}),x("polyline",{class:"st0",stroke:"#fff","stroke-width":"10",points:"43.5,77.8 63.7,97.9 112.2,49.4 ",style:{"stroke-dasharray":"100px, 100px","stroke-dashoffset":"200px"}})])])])],-1)),e[6]||(e[6]=x("h2",{class:"font-bold text-base mx-auto md:text-lg"},"Done!",-1)),e[7]||(e[7]=x("h1",{class:"font-semibold text-base text-center"}," Your score has been recorded successfully!",-1)),x("div",rD,[ue(a,{to:"/scorePage"},{default:et(()=>e[1]||(e[1]=[it(" View Your Score.")])),_:1})]),x("h2",oD,[e[2]||(e[2]=it(" You will be rediected to back Home in :")),x("span",iD,Oe(o.timer),1),e[3]||(e[3]=it(" seconds. "))])])])])],512),[[Ba,r.showPage]])]),_:1})}const aD=on(JL,[["render",sD],["__scopeId","data-v-3ef70819"]]),lD={data(){return{showEye:!0}},methods:{eyes(){this.showEye=!this.showEye}},setup(){let t=!0;const e=ri(),n=Er({});return{toggleShowProductPage:()=>{Ee.push("/")},login:()=>{e.dispatch("login",n.value)},registerForm:n,showPassword:()=>{const s=document.getElementById("password");s.type==="password"?s.type="text":s.type="password"},showPage:t}}},cD={class:"fixed outline-none flex flex-col bottom-0 h-full w-full bg-black z-40 bg-opacity-30 text-slate-800"},uD={class:"flex flex-col h-5/6 rounded-xl m-auto pt-2 pb-5 w-wd9 md:w-wd7 lg:w-wd45 xl:w-wd45 overflow-x-hidden overflow-y-auto overflow-hidden bg-slate-100 shadow-sm"},dD={class:"flex z-50 my-auto md:py-2 w-full h-full"},hD={class:"w-full h-fit py-2 flex flex-col px-2 md:h-full m-auto md:m-0"},fD={class:"w-full h-full space-y-2 flex flex-col md:space-y-3"},pD={class:"flex flex-col space-y-3 md:flex-col text-xs md:text-sm"},mD={class:"bg-inherit m-auto w-11/12 md:m-auto md:w-full lg:w-3/4 lg:m-auto border-b-2 flex border-slate-400"},gD={class:"w-full flex justify-evenly md:justify-between mt-10 text-sm font-normal md:font-semibold border-red-500 md:mx-auto md:w-3/4"};function yD(t,e,n,r,o,i){const s=ke("font-awesome-icon"),a=ke("router-link");return j(),ze(os,{name:"slide-fade"},{default:et(()=>[ut(x("div",cD,[x("div",{onClick:e[0]||(e[0]=l=>r.toggleShowProductPage()),class:"z-50 mx-auto mt-6 -mb-5 w-8 h-8 md:w-12 md:h-12 shadow-md cursor-pointer p-2 hover:bg-slate-300 transition-all rounded-full flex bg-gray-100"},[ue(s,{icon:"fa-solid fa-x",size:"sm",style:{color:"#333366"},class:"md:hidden m-auto rounded-full"}),ue(s,{icon:"fa-solid fa-x",size:"lg",style:{color:"#333366"},class:"hidden md:block m-auto rounded-full"})]),x("div",uD,[x("div",dD,[x("div",hD,[e[14]||(e[14]=x("img",{src:ls,alt:"Fpa logo",class:"w-16 -mt-2 md:w-28 md:m-auto mx-auto"},null,-1)),x("div",fD,[e[10]||(e[10]=x("h2",{class:"text-slate-800 mx-auto font-bold text-lg"},"Login",-1)),e[11]||(e[11]=x("h4",{class:"text-slate-800 font-bold text-xs text-center"},"Enter your details below to Login.",-1)),x("form",{name:"emailAndPassword",onSubmit:e[5]||(e[5]=bf(l=>r.login(),["prevent"])),class:"flex flex-col space-y-3"},[x("div",pD,[e[7]||(e[7]=x("label",{for:"Email",class:"bg-inherit mx-auto -yb-10 w-11/12 md:w-full lg:w-3/4 lg:mx-auto indent-1 font-bold"},"Enter Email Address:",-1)),ut(x("input",{name:"Email",type:"email","onUpdate:modelValue":e[1]||(e[1]=l=>r.registerForm.email=l),placeholder:"Johndeo@gmail.com",class:"bg-inherit m-auto py-2 w-11/12 md:w-full lg:w-3/4 lg:mx-auto indent-1 font-semibold border-b-2 border-slate-400"},null,512),[[fr,r.registerForm.email,void 0,{trim:!0,lazy:!0}]]),e[8]||(e[8]=x("label",{for:"password",class:"bg-inherit mx-auto -yb-10 w-11/12 md:w-full lg:w-3/4 lg:mx-auto indent-1 font-bold"},"Enter Password:",-1)),x("div",mD,[ut(x("input",{id:"password",type:"password","onUpdate:modelValue":e[2]||(e[2]=l=>r.registerForm.password=l),class:"bg-inherit m-auto py-2 w-11/12 indent-1 font-semibold"},null,512),[[fr,r.registerForm.password,void 0,{trim:!0,lazy:!0}]]),o.showEye?(j(),ze(s,{key:0,icon:"fa-solid fa-eye",onClick:e[3]||(e[3]=l=>(r.showPassword(),i.eyes())),class:"p-1 m-auto md:p-2 -mr-0 text-gray-600 border-2 rounded-md border-slate-400"})):(j(),ze(s,{key:1,icon:"fa-solid fa-eye-slash",onClick:e[4]||(e[4]=l=>(r.showPassword(),i.eyes())),class:"p-1 m-auto md:p-2 -mr-0 text-gray-600 border-2 rounded-md border-slate-400"}))])]),e[9]||(e[9]=x("input",{type:"submit",value:"Login",class:"bg-purple-900 font-bold text-slate-200 mx-auto w-fit px-6 py-1 hover:px-7 hover:py-2 rounded-lg transition-all shadow-lg"},null,-1))],32)]),x("div",gD,[e[13]||(e[13]=x("p",{class:"text-center my-auto"},"New to the system? Proceed to ",-1)),ue(a,{to:"/Signup",onClick:e[6]||(e[6]=l=>t.stopVid()),class:"bg-purple-900 text-slate-200 my-auto px-2 py-1 hover:px-7 hover:py-2 rounded-lg transition-all shadow-lg"},{default:et(()=>e[12]||(e[12]=[it(" Sign Up")])),_:1})])])])])],512),[[Ba,r.showPage]])]),_:1})}const vD=on(lD,[["render",yD]]),bD={components:{headerComponent:Su},data(){return{userName:"",score:"No score yet. Go back and take the test.",documents:[],verification:""}},mounted(){this.getRoute()},methods:{async updateUser(){if(this.userName!=""&&this.verification!=""){const t=lo(_r,"users",this.userName);await mr(t).then(e=>{e.exists()&&Dh(t,{verification:this.verification}).then(()=>{this.userName="",this.verification="",alert("User Verification Status Updated."),window.location.reload()}).catch(n=>{console.log(n)})})}else alert("Please select the user and verification status.")},getRoute(){const t=c9();console.log(t.name),this.$store.state.user!="admin"&&t.name=="admin"?(console.log("authenticate user not admin"),Ee.push("/home")):localStorage.getItem("user")&&t.name=="admin"?(console.log("local storage user not admin"),Ee.push("/home")):this.fetchData()},async fetchData(){try{(await I5(a5(_r,"users"))).forEach(e=>{this.documents.push({id:e.id,data:e.data()})}),console.log(this.documents)}catch(t){console.log(t)}}}},_D={class:"w-full h-fit absolute flex flex-col"},wD={class:"flex flex-col h-fit rounded-xl my-5 mx-auto pb-2 w-fit md:w-wd7 lg:w-wd8 xl:w-wd45 bg-slate-100 shadow-sm"},ED={class:"flex z-50 my-auto md:py-2 w-full h-full border-blue-500"},ID={class:"w-full h-full py-2 flex flex-col px-2 border-red-500 mx-auto space-y-10"},TD={class:"w-full space-y-2 flex flex-col"},SD={class:""},AD={class:"border-black border-2 md:border-4 w-fit uppercase py-2"},CD={class:"border-black border-2 md:border-4 w-fit lowercase"},xD={class:"border-black border-2 md:border-4 w-fit uppercase"},PD={class:"border-black border-2 md:border-4 w-fit uppercase"},kD={class:"border-black border-2 md:border-4 w-fit uppercase"},OD={class:"border-black border-2 md:border-4 w-fit uppercase"},RD={class:"border-black border-2 md:border-4 w-fit uppercase"},ND={class:"flex flex-col space-y-3"},LD={class:"border-blue-500 flex w-full md:w-3/4 mx-auto"},DD={class:"flex flex-col border-black w-full mx-5"},VD=["value"],MD={class:"flex flex-col border-black w-full"},$D={class:"w-full flex justify-evenly md:justify-between font-semibold border-red-500 md:mx-auto md:w-2/4"};function FD(t,e,n,r,o,i){const s=ke("header-component");return j(),ne("div",_D,[ue(s),x("div",wD,[x("div",ED,[x("div",ID,[x("div",TD,[e[4]||(e[4]=x("h2",{class:"text-slate-800 mx-auto font-bold text-lg md:text-2xl uppercase"},"Admin Page.",-1)),x("table",SD,[e[3]||(e[3]=x("tr",{class:"border-black rounded-t-xl border-2 md:border-4 font-bold text-center text-sm md:text-lg uppercase"},[x("td",null,"Name"),x("td",null,"Email"),x("td",null,"Matric Number"),x("td",null,"Department"),x("td",null,"Level"),x("td",null,"Score"),x("td",null,"Verification")],-1)),(j(!0),ne(qe,null,Rn(o.documents,a=>(j(),ne("tr",{key:a.id,class:"border-blue-500 border-2 md:border-4 text-xs md:text-base"},[x("td",AD,Oe(a.data.name),1),x("td",CD,Oe(a.data.email),1),x("td",xD,Oe(a.data.matric),1),x("td",PD,Oe(a.data.department),1),x("td",kD,Oe(a.data.level),1),x("td",OD,Oe(a.data.score),1),x("td",RD,Oe(a.data.verification),1)]))),128))])]),x("div",ND,[e[8]||(e[8]=x("h4",{class:"text-slate-800 font-bold text-base md:text-lg text-center uppercase"},"User Verification.",-1)),x("div",LD,[x("div",DD,[e[5]||(e[5]=x("label",{for:"userName",class:"text-base font-bold md:text-lg md:font-bold"},"User Name:",-1)),ut(x("select",{name:"userName",id:"username","onUpdate:modelValue":e[0]||(e[0]=a=>o.userName=a)},[(j(!0),ne(qe,null,Rn(o.documents,a=>(j(),ne("option",{value:a.data.name,key:a.id,class:"bg-inherit m-auto py-2 w-11/12 md:w-full lg:w-3/4 lg:mx-auto indent-1 font-semibold border-b-2 border-slate-400"},Oe(a.data.name),9,VD))),128))],512),[[Gs,o.userName]])]),x("div",MD,[e[7]||(e[7]=x("label",{for:"verification",class:"text-base font-bold md:text-lg md:font-bold"},"Verification Status:",-1)),ut(x("select",{name:"verification",id:"verification","onUpdate:modelValue":e[1]||(e[1]=a=>o.verification=a)},e[6]||(e[6]=[x("option",{value:"verified",class:"bg-inherit indent-1 font-semibold border-b-2 border-slate-400"}," verified ",-1),x("option",{value:"Unverified",class:"bg-inherit indent-1 font-semibold border-b-2 border-slate-400"}," Unverified ",-1)]),512),[[Gs,o.verification]])])])]),x("div",$D,[x("button",{onClick:e[2]||(e[2]=a=>i.updateUser()),class:"bg-purple-900 text-slate-200 mx-auto px-2 py-1 hover:px-7 hover:py-2 rounded-lg transition-all shadow-lg"},"Submit Verification.")])])])])])}const UD=on(bD,[["render",FD]]),jD={data(){return{showEye:!0}},methods:{eyes(){this.showEye=!this.showEye}},setup(){let t=!0;const e=ri(),n=Er({});return{toggleShowProductPage:()=>{Ee.push("/")},login:()=>{e.dispatch("AdminLogin",n.value)},registerForm:n,showPassword:()=>{const s=document.getElementById("password");s.type==="password"?s.type="text":s.type="password"},showPage:t}}},BD={class:"fixed outline-none flex flex-col bottom-0 h-full w-full bg-black z-40 bg-opacity-30 text-slate-800"},zD={class:"flex flex-col h-5/6 rounded-xl m-auto pt-2 pb-5 w-wd9 md:w-wd7 lg:w-wd45 xl:w-wd45 overflow-x-hidden overflow-y-auto overflow-hidden bg-slate-100 shadow-sm"},HD={class:"flex z-50 my-auto md:py-2 w-full h-full"},KD={class:"w-full h-fit py-2 flex flex-col px-2 md:h-full m-auto md:m-0"},WD={class:"w-full h-full space-y-2 flex flex-col md:space-y-3"},qD={class:"flex flex-col space-y-3 md:flex-col text-xs md:text-sm"},GD={class:"bg-inherit m-auto w-11/12 md:m-auto md:w-full lg:w-3/4 lg:m-auto border-b-2 flex border-slate-400"};function QD(t,e,n,r,o,i){const s=ke("font-awesome-icon");return j(),ze(os,{name:"slide-fade"},{default:et(()=>[ut(x("div",BD,[x("div",{onClick:e[0]||(e[0]=a=>r.toggleShowProductPage()),class:"z-50 mx-auto mt-6 -mb-5 w-8 h-8 md:w-12 md:h-12 shadow-md cursor-pointer p-2 hover:bg-slate-300 transition-all rounded-full flex bg-gray-100"},[ue(s,{icon:"fa-solid fa-x",size:"sm",style:{color:"#333366"},class:"md:hidden m-auto rounded-full"}),ue(s,{icon:"fa-solid fa-x",size:"lg",style:{color:"#333366"},class:"hidden md:block m-auto rounded-full"})]),x("div",zD,[x("div",HD,[x("div",KD,[e[11]||(e[11]=x("img",{src:ls,alt:"Fpa logo",class:"w-16 -mt-2 md:w-28 md:m-auto mx-auto"},null,-1)),x("div",WD,[e[9]||(e[9]=x("h2",{class:"text-slate-800 mx-auto font-bold text-lg"},"Admin Login.",-1)),e[10]||(e[10]=x("h4",{class:"text-slate-800 font-bold text-xs text-center"},"Provide your details below to as Admin to Login.",-1)),x("form",{name:"emailAndPassword",onSubmit:e[5]||(e[5]=bf(a=>r.login(),["prevent"])),class:"flex flex-col space-y-3"},[x("div",qD,[e[6]||(e[6]=x("label",{for:"Email",class:"bg-inherit mx-auto -yb-10 w-11/12 md:w-full lg:w-3/4 lg:mx-auto indent-1 font-bold"},"Enter Email Address:",-1)),ut(x("input",{name:"Email",type:"email","onUpdate:modelValue":e[1]||(e[1]=a=>r.registerForm.email=a),placeholder:"Admin@gmail.com",class:"bg-inherit m-auto py-2 w-11/12 md:w-full lg:w-3/4 lg:mx-auto indent-1 font-semibold border-b-2 border-slate-400"},null,512),[[fr,r.registerForm.email,void 0,{trim:!0,lazy:!0}]]),e[7]||(e[7]=x("label",{for:"password",class:"bg-inherit mx-auto -yb-10 w-11/12 md:w-full lg:w-3/4 lg:mx-auto indent-1 font-bold"},"Enter Password:",-1)),x("div",GD,[ut(x("input",{id:"password",type:"password","onUpdate:modelValue":e[2]||(e[2]=a=>r.registerForm.password=a),class:"bg-inherit m-auto py-2 w-11/12 indent-1 font-semibold"},null,512),[[fr,r.registerForm.password,void 0,{trim:!0,lazy:!0}]]),o.showEye?(j(),ze(s,{key:0,icon:"fa-solid fa-eye",onClick:e[3]||(e[3]=a=>(r.showPassword(),i.eyes())),class:"p-1 m-auto md:p-2 -mr-0 text-gray-600 border-2 rounded-md border-slate-400"})):(j(),ze(s,{key:1,icon:"fa-solid fa-eye-slash",onClick:e[4]||(e[4]=a=>(r.showPassword(),i.eyes())),class:"p-1 m-auto md:p-2 -mr-0 text-gray-600 border-2 rounded-md border-slate-400"}))])]),e[8]||(e[8]=x("input",{type:"submit",value:"Login",class:"bg-purple-900 font-bold text-slate-200 mx-auto w-fit px-6 py-1 hover:px-7 hover:py-2 rounded-lg transition-all shadow-lg"},null,-1))],32)])])])])],512),[[Ba,r.showPage]])]),_:1})}const YD=on(jD,[["render",QD]]),Ee=a9({history:M6("/FPA-E-EXAM"),routes:[{path:"/",name:"landingPage",component:b9},{path:"/adminLogin",name:"adminLogin",component:YD},{path:"/login",name:"login",component:V5},{path:"/signup",name:"signup",component:Y5},{path:"/manualLogin",name:"manualLogin",component:vD},{path:"/confirmSignup",name:"confirmSignup",component:XL},{path:"/confirmScore",name:"confirmScore",component:aD,meta:{requiresAuth:!0}},{path:"/admin",name:"admin",component:UD,meta:{requiresAuth:!0}},{path:"/home",name:"home",component:hL,meta:{requiresAuth:!0}},{path:"/scorePage",name:"scorePage",component:jL,meta:{requiresAuth:!0}},{path:"/examPage",name:"examPage",component:PL,meta:{requiresAuth:!0}}]});je.onAuthStateChanged(t=>{if(!t)return Ee.push("/");Ee.beforeEach(async e=>{if(e.path=="/"&&je.currentUser||e.path=="/login"&&je.currentUser||e.path=="/adminLogin"&&je.currentUser||e.path=="/signup"&&je.currentUser)return Ee.push(Ee.currentRoute);if(e.path=="/admin"&&!je.currentUser)return Ee.push("/");if(e.path=="/admin"&&je.currentUser&&je.currentUser.displayName!="admin")return console.log("Authenticated user intruding to admin page"),alert("You are not authorized to view this page!"),await je.signOut(je),Ee.push("/");if(e.path=="/Home"&&!je.currentUser||e.path=="/scorePage"&&!je.currentUser||e.path=="/examPage"&&!je.currentUser||e.path=="/confirmScore"&&!je.currentUser)return Ee.push("/")})});const XD={setup(){const t=ri(),e=jf();l0(()=>{t.dispatch("fetchUser")}),qc(()=>{IR(e,n=>{n?(n.getIdToken().then(r=>{document.cookie=`session= ${r}; max-age= ${60*60*24}`}),_R(e,$f)):Ee.push("/")})})}};function JD(t,e,n,r,o,i){const s=ke("router-view");return j(),ne("div",null,[ue(s)])}const ZD=on(XD,[["render",JD]]),eV=i6({state:{user:null,correctAnswer:0,userAnswer:[],overallScore:0,questions:[{questionDetails:{name:"Question1",question:"Add 1 + 1 =",options:["(A) 20","(B) 0","(C) 2","(D) 15"],answer:"(C) 2"}},{questionDetails:{name:"Question2",question:"What is your supervisor name?",options:["(A) Mrs Abiodun","(B) A.O Ajao","(C) Dr. Fele","(D) Ms Ogunji"],answer:"(A) Mrs Abiodun"}},{questionDetails:{name:"Question3",question:"What goes up and doesn't come down?",options:["(A) Ball","(B) Age","(C) Naira","(D) Plane"],answer:"(B) Age"}},{questionDetails:{name:"Question4",question:"What is the opposite of the light?",options:["(A) Indigo","(B) Yellow","(C) Brown","(D) Dark"],answer:"(D) Dark"}},{questionDetails:{name:"Question5",question:"Which is the smallest?",options:["(A) Atom","(B) Molecule","(C) Droplet","(D) Stream"],answer:"(A) Atom"}}]},mutations:{setUser(t,e){t.user=e},clearUser(t){t.user=null},calculateAnswers(t,e){t.userAnswer=e,console.log(t.userAnswer);for(let n=0;n<t.questions.length;n++)t.userAnswer[n]==t.questions[n].questionDetails.answer&&t.correctAnswer++;console.log("correct answer:"+t.correctAnswer),t.overallScore=t.correctAnswer/t.questions.length*100,console.log(t.overallScore+" / 100"),t.userAnswer=[],t.correctAnswer=0}},actions:{async submitQuiz({commit:t,state:e},n){if(t("calculateAnswers",n),e.user==null){console.log("Anon user = "+localStorage.getItem("user"));const r=lo(_r,"users",localStorage.getItem("user"));await mr(r).then(o=>{o.exists()&&(console.log("Anon user has data in Firebase"),console.log("User current score :"+o.data().score),Dh(r,{score:e.overallScore}))}),await mr(r).then(o=>{o.exists()?console.log("Updated score: "+o.data().score):console.log("No data")})}else if(e.user!=null){console.log("currently logged in user = "+e.user);const r=lo(_r,"users",e.user);await mr(r).then(o=>{o.exists()?(console.log("User has data in Firebase"),console.log("User current score :"+o.data().score),Dh(r,{score:e.overallScore})):console.log("No data")}),await mr(r).then(o=>{o.exists()?console.log("Updated score: "+o.data().score):console.log("No data")})}},async anonSignin({commit:t},e){try{await fR(je),t("setUser",e),localStorage.setItem("user",e),console.log(localStorage.getItem("user")),Ee.push("/home")}catch(n){console.log(n)}},async AdminLogin({commit:t},e){const{email:n,password:r}=e;try{await Py(je,n,r)}catch(o){switch(o.code){case"auth/invalid-email":alert("Invalid email");break;case"auth/user-disabled":alert("User disabled");break;case"auth/user-not-found":alert("User not found");break;case"auth/wrong-password":alert("Wrong password");break;case"auth/missing-password":alert("Missing password");break;case"auth/missing-email":alert("Missing email");break;case"auth/invalid-password":alert("Invalid password");break;case"auth/operation-not-allowed":alert("Operation not allowed");break;case"auth/network-request-failed":alert("Network request failed");break;case"auth/too-many-requests":alert("Too many requests");break;default:alert("Something went wrong");break}return}t("setUser",je.currentUser.displayName),Ee.push("/admin")},async login({commit:t},e){const{email:n,password:r}=e;try{await Py(je,n,r)}catch(i){switch(i.code){case"auth/invalid-email":alert("Invalid email");break;case"auth/user-disabled":alert("User disabled");break;case"auth/user-not-found":alert("User not found");break;case"auth/wrong-password":alert("Wrong password");break;case"auth/missing-password":alert("Missing password");break;case"auth/missing-email":alert("Missing email");break;case"auth/invalid-password":alert("Invalid password");break;case"auth/operation-not-allowed":alert("Operation not allowed");break;case"auth/network-request-failed":alert("Network request failed");break;case"auth/too-many-requests":alert("Too many requests");break;default:alert("Something went wrong");break}return}console.log(je.currentUser);const o=lo(_r,"users",je.currentUser.displayName);await mr(o).then(i=>{i.exists()&&(i.data().verification=="Unverified"?(alert("Face not yet captured"),navigator.vibrate([100,50,100]),t("clearUser"),je.signOut(je)):(t("setUser",je.currentUser.displayName),Ee.push("/home")))})},async register({commit:t},e){const{email:n,password:r,name:o,matric:i,age:s,department:a,level:l,gender:u}=e;try{await yR(je,n,r)}catch(f){switch(f.code){case"auth/email-already-in-use":alert("Email already in use");break;case"auth/invalid-email":alert("Invalid email");break;case"auth/weak-password":alert("Weak password");break;case"auth/missing-password":alert("Missing password");break;case"auth/missing-email":alert("Missing email");break;case"auth/invalid-password":alert("Invalid password");break;case"auth/operation-not-allowed":alert("Operation not allowed");break;case"auth/network-request-failed":alert("Network request failed");break;case"auth/too-many-requests":alert("Too many requests");break;default:alert("Something went wrong");break}return}t("setUser",je.currentUser.displayName),Ee.push("/confirmSignup");const d=jf().currentUser;bR(d,{displayName:o,matricNumber:i,verification:"Unverified",age:s,score:0,department:a,level:l,gender:u}).then(()=>{console.log("User created successfully")}).catch(f=>{console.log(f)}),T5(lo(_r,"users",o),{email:n,name:o,matric:i,age:s,verification:"Unverified",score:0,department:a,level:l,gender:u},{merge:!0})},async logOut({commit:t}){t("clearUser"),localStorage.removeItem("user"),console.log(localStorage),await je.signOut(je),Ee.push("/")},fetchUser({commit:t}){je.onAuthStateChanged(async e=>{e==null?Ee.push(Ee.currentRoute):(t("setUser",je.currentUser.displayName),Ee.isReady()&&Ee.currentRoute.value.path=="/"&&Ee.push("/home"))})}}}),$n=QA(ZD);$n.use(Ee);$n.use(eV);$n.use(E2,{unstyled:!0});gT.add(dC,uC,hC);$n.use(Jx);$n.component("font-awesome-icon",cC);$n.component("Avatar",u1);$n.component("Select",E1);$n.component("InputText",Cf);$n.component("Toast",h1);$n.component("Button",c1);$n.mount("#app");
