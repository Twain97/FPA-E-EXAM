 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */io(o9,i9,"app");var By=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class A1{constructor(e,n){this.user=n,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}class s9{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,n){e.enqueueRetryable(()=>n(Lt.UNAUTHENTICATED))}shutdown(){}}class a9{constructor(e){this.token=e,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(e,n){this.changeListener=n,e.enqueueRetryable(()=>n(this.token.user))}shutdown(){this.changeListener=null}}class l9{constructor(e){this.t=e,this.currentUser=Lt.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(e,n){let r=this.i;const o=l=>this.i!==r?(r=this.i,n(l)):Promise.resolve();let i=new pr;this.o=()=>{this.i++,this.currentUser=this.u(),i.resolve(),i=new pr,e.enqueueRetryable(()=>o(this.currentUser))};const s=()=>{const l=i;e.enqueueRetryable(async()=>{await l.promise,await o(this.currentUser)})},a=l=>{oe("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=l,this.auth.addAuthTokenListener(this.o),s()};this.t.onInit(l=>a(l)),setTimeout(()=>{if(!this.auth){const l=this.t.getImmediate({optional:!0});l?a(l):(oe("FirebaseAuthCredentialsProvider","Auth not yet detected"),i.resolve(),i=new pr)}},0),s()}getToken(){const e=this.i,n=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(n).then(r=>this.i!==e?(oe("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):r?(Ye(typeof r.accessToken=="string"),new A1(r.accessToken,this.currentUser)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.auth.removeAuthTokenListener(this.o)}u(){const e=this.auth&&this.auth.getUid();return Ye(e===null||typeof e=="string"),new Lt(e)}}class c9{constructor(e,n,r){this.l=e,this.h=n,this.P=r,this.type="FirstParty",this.user=Lt.FIRST_PARTY,this.I=new Map}T(){return this.P?this.P():null}get headers(){this.I.set("X-Goog-AuthUser",this.l);const e=this.T();return e&&this.I.set("Authorization",e),this.h&&this.I.set("X-Goog-Iam-Authorization-Token",this.h),this.I}}class u9{constructor(e,n,r){this.l=e,this.h=n,this.P=r}getToken(){return Promise.resolve(new c9(this.l,this.h,this.P))}start(e,n){e.enqueueRetryable(()=>n(Lt.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class d9{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class h9{constructor(e){this.A=e,this.forceRefresh=!1,this.appCheck=null,this.R=null}start(e,n){const r=i=>{i.error!=null&&oe("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${i.error.message}`);const s=i.token!==this.R;return this.R=i.token,oe("FirebaseAppCheckTokenProvider",`Received ${s?"new":"existing"} token.`),s?n(i.token):Promise.resolve()};this.o=i=>{e.enqueueRetryable(()=>r(i))};const o=i=>{oe("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=i,this.appCheck.addTokenListener(this.o)};this.A.onInit(i=>o(i)),setTimeout(()=>{if(!this.appCheck){const i=this.A.getImmediate({optional:!0});i?o(i):oe("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}},0)}getToken(){const e=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(e).then(n=>n?(Ye(typeof n.token=="string"),this.R=n.token,new d9(n.token)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.appCheck.removeTokenListener(this.o)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const v9="The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.";class b9{constructor(){this.onCommittedListeners=[]}addOnCommittedListener(e){this.onCommittedListeners.push(e)}raiseOnCommittedEvent(){this.onCommittedListeners.forEach(e=>e())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ba(t){if(t.code!==z.FAILED_PRECONDITION||t.message!==v9)throw t;oe("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Df{constructor(e,n){this.previousValue=e,n&&(n.sequenceNumberHandler=r=>this.ie(r),this.se=r=>n.writeSequenceNumber(r))}ie(e){return this.previousValue=Math.max(e,this.previousValue),this.previousValue}next(){const e=++this.previousValue;return this.se&&this.se(e),e}}Df.oe=-1;function Zc(t){return t==null}function mc(t){return t===0&&1/t==-1/0}function w9(t){return typeof t=="number"&&Number.isInteger(t)&&!mc(t)&&t<=Number.MAX_SAFE_INTEGER&&t>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yc{constructor(e,n="asc"){this.field=e,this.dir=n}}function A9(t,e){return t.dir===e.dir&&t.field.isEqual(e.field)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class O1{}class pt extends O1{constructor(e,n,r){super(),this.field=e,this.op=n,this.value=r}static create(e,n,r){return e.isKeyField()?n==="in"||n==="not-in"?this.createKeyFieldInFilter(e,n,r):new x9(e,n,r):n==="array-contains"?new O9(e,r):n==="in"?new R9(e,r):n==="not-in"?new N9(e,r):n==="array-contains-any"?new L9(e,r):new pt(e,n,r)}static createKeyFieldInFilter(e,n,r){return n==="in"?new P9(e,r):new k9(e,r)}matches(e){const n=e.data.field(this.field);return this.op==="!="?n!==null&&this.matchesComparison(zi(n,this.value)):n!==null&&Yo(this.value)===Yo(n)&&this.matchesComparison(zi(n,this.value))}matchesComparison(e){switch(this.op){case"<":return e<0;case"<=":return e<=0;case"==":return e===0;case"!=":return e!==0;case">":return e>0;case">=":return e>=0;default:return me()}}isInequality(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}getFlattenedFilters(){return[this]}getFilters(){return[this]}}class Yn extends O1{constructor(e,n){super(),this.filters=e,this.op=n,this.ae=null}static create(e,n){return new Yn(e,n)}matches(e){return R1(this)?this.filters.find(n=>!n.matches(e))===void 0:this.filters.find(n=>n.matches(e))!==void 0}getFlattenedFilters(){return this.ae!==null||(this.ae=this.filters.reduce((e,n)=>e.concat(n.getFlattenedFilters()),[])),this.ae}getFilters(){return Object.assign([],this.filters)}}function R1(t){return t.op==="and"}function N1(t){return C9(t)&&R1(t)}function C9(t){for(const e of t.filters)if(e instanceof Yn)return!1;return!0}function fh(t){if(t instanceof pt)return t.field.canonicalString()+t.op.toString()+Hi(t.value);if(N1(t))return t.filters.map(e=>fh(e)).join(",");{const e=t.filters.map(n=>fh(n)).join(",");return`${t.op}(${e})`}}function L1(t,e){return t instanceof pt?function(r,o){return o instanceof pt&&r.op===o.op&&r.field.isEqual(o.field)&&Qn(r.value,o.value)}(t,e):t instanceof Yn?function(r,o){return o instanceof Yn&&r.op===o.op&&r.filters.length===o.filters.length?r.filters.reduce((i,s,a)=>i&&L1(s,o.filters[a]),!0):!1}(t,e):void me()}function V1(t){return t instanceof pt?function(n){return`${n.field.canonicalString()} ${n.op} ${Hi(n.value)}`}(t):t instanceof Yn?function(n){return n.op.toString()+" {"+n.getFilters().map(V1).join(" ,")+"}"}(t):"Filter"}class x9 extends pt{constructor(e,n,r){super(e,n,r),this.key=fe.fromName(r.referenceValue)}matches(e){const n=fe.comparator(e.key,this.key);return this.matchesComparison(n)}}class P9 extends pt{constructor(e,n){super(e,"in",n),this.keys=D1("in",n)}matches(e){return this.keys.some(n=>n.isEqual(e.key))}}class k9 extends pt{constructor(e,n){super(e,"not-in",n),this.keys=D1("not-in",n)}matches(e){return!this.keys.some(n=>n.isEqual(e.key))}}function D1(t,e){var n;return(((n=e.arrayValue)===null||n===void 0?void 0:n.values)||[]).map(r=>fe.fromName(r.referenceValue))}class O9 extends pt{constructor(e,n){super(e,"array-contains",n)}matches(e){const n=e.data.field(this.field);return Ff(n)&&Ca(n.arrayValue,this.value)}}class R9 extends pt{constructor(e,n){super(e,"in",n)}matches(e){const n=e.data.field(this.field);return n!==null&&Ca(this.value.arrayValue,n)}}class N9 extends pt{constructor(e,n){super(e,"not-in",n)}matches(e){if(Ca(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;const n=e.data.field(this.field);return n!==null&&!Ca(this.value.arrayValue,n)}}class L9 extends pt{constructor(e,n){super(e,"array-contains-any",n)}matches(e){const n=e.data.field(this.field);return!(!Ff(n)||!n.arrayValue.values)&&n.arrayValue.values.some(r=>Ca(this.value.arrayValue,r))}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const j9=new ct(fe.comparator);function wr(){return j9}const F1=new ct(fe.comparator);function Os(...t){let e=F1;for(const n of t)e=e.insert(n.key,n);return e}function U1(t){let e=F1;return t.forEach((n,r)=>e=e.insert(n,r.overlayedDocument)),e}function Do(){return Qs()}function j1(){return Qs()}function Qs(){return new ts(t=>t.toString(),(t,e)=>t.isEqual(e))}const B9=new ct(fe.comparator),z9=new xt(fe.comparator);function Te(...t){let e=z9;for(const n of t)e=e.add(n);return e}const H9=new xt(Me);function K9(){return H9}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zf(t,e){if(t.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:mc(e)?"-0":e}}function B1(t){return{integerValue:""+t}}function W9(t,e){return w9(e)?B1(e):zf(t,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class T3{constructor(e){this.ct=e}}function S3(t){const e=v3({parent:t.parent,structuredQuery:t.structuredQuery});return t.limitType==="LAST"?mh(e,e.limit,"L"):e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class x3{constructor(){this.changes=new ts(e=>e.toString(),(e,n)=>e.isEqual(n)),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,n){this.assertNotApplied(),this.changes.set(e,Vt.newInvalidDocument(e).setReadTime(n))}getEntry(e,n){this.assertNotApplied();const r=this.changes.get(n);return r!==void 0?H.resolve(r):this.getFromCache(e,n)}getEntries(e,n){return this.getAllFromCache(e,n)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class N3{constructor(){this.sessionToken=Pt.EMPTY_BYTE_STRING}getSessionToken(e){return H.resolve(this.sessionToken)}setSessionToken(e,n){return this.sessionToken=n,H.resolve()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $3{constructor(e,n){this.qr={},this.overlays={},this.Qr=new Df(0),this.Kr=!1,this.Kr=!0,this.$r=new N3,this.referenceDelegate=e(this),this.Ur=new M3(this),this.indexManager=new A3,this.remoteDocumentCache=function(o){return new V3(o)}(r=>this.referenceDelegate.Wr(r)),this.serializer=new T3(n),this.Gr=new O3(this.serializer)}start(){return Promise.resolve()}shutdown(){return this.Kr=!1,Promise.resolve()}get started(){return this.Kr}setDatabaseDeletedListener(){}setNetworkEnabled(){}getIndexManager(e){return this.indexManager}getDocumentOverlayCache(e){let n=this.overlays[e.toKey()];return n||(n=new R3,this.overlays[e.toKey()]=n),n}getMutationQueue(e,n){let r=this.qr[e.toKey()];return r||(r=new L3(n,this.referenceDelegate),this.qr[e.toKey()]=r),r}getGlobalsCache(){return this.$r}getTargetCache(){return this.Ur}getRemoteDocumentCache(){return this.remoteDocumentCache}getBundleCache(){return this.Gr}runTransaction(e,n,r){oe("MemoryPersistence","Starting transaction:",e);const o=new F3(this.Qr.next());return this.referenceDelegate.zr(),r(o).next(i=>this.referenceDelegate.jr(o).next(()=>i)).toPromise().then(i=>(o.raiseOnCommittedEvent(),i))}Hr(e,n){return H.or(Object.values(this.qr).map(r=>()=>r.containsKey(e,n)))}}class F3 extends b9{constructor(e){super(),this.currentSequenceNumber=e}}class Gf{constructor(e){this.persistence=e,this.Jr=new qf,this.Yr=null}static Zr(e){return new Gf(e)}get Xr(){if(this.Yr)return this.Yr;throw me()}addReference(e,n,r){return this.Jr.addReference(r,n),this.Xr.delete(r.toString()),H.resolve()}removeReference(e,n,r){return this.Jr.removeReference(r,n),this.Xr.add(r.toString()),H.resolve()}markPotentiallyOrphaned(e,n){return this.Xr.add(n.toString()),H.resolve()}removeTarget(e,n){this.Jr.gr(n.targetId).forEach(o=>this.Xr.add(o.toString()));const r=this.persistence.getTargetCache();return r.getMatchingKeysForTargetId(e,n.targetId).next(o=>{o.forEach(i=>this.Xr.add(i.toString()))}).next(()=>r.removeTargetData(e,n))}zr(){this.Yr=new Set}jr(e){const n=this.persistence.getRemoteDocumentCache().newChangeBuffer();return H.forEach(this.Xr,r=>{const o=fe.fromPath(r);return this.ei(e,o).next(i=>{i||n.removeEntry(o,ye.min())})}).next(()=>(this.Yr=null,n.apply(e)))}updateLimboDocument(e,n){return this.ei(e,n).next(r=>{r?this.Xr.delete(n.toString()):this.Xr.add(n.toString())})}Wr(e){return 0}ei(e,n){return H.or([()=>H.resolve(this.Jr.containsKey(n)),()=>this.persistence.getTargetCache().containsKey(e,n),()=>this.persistence.Hr(e,n)])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class j3{constructor(){this.Gi=!1,this.zi=!1,this.ji=100,this.Hi=function(){return UP()?8:_9(Mt())>0?6:4}()}initialize(e,n){this.Ji=e,this.indexManager=n,this.Gi=!0}getDocumentsMatchingQuery(e,n,r,o){const i={result:null};return this.Yi(e,n).next(s=>{i.result=s}).next(()=>{if(!i.result)return this.Zi(e,n,o,r).next(s=>{i.result=s})}).next(()=>{if(i.result)return;const s=new U3;return this.Xi(e,n,s).next(a=>{if(i.result=a,this.zi)return this.es(e,n,s,a.size)})}).next(()=>i.result)}es(e,n,r,o){return r.documentReadCount<this.ji?(Is()<=Ae.DEBUG&&oe("QueryEngine","SDK will not create cache indexes for query:",hi(n),"since it only creates cache indexes for collection contains","more than or equal to",this.ji,"documents"),H.resolve()):(Is()<=Ae.DEBUG&&oe("QueryEngine","Query:",hi(n),"scans",r.documentReadCount,"local documents and returns",o,"documents as results."),r.documentReadCount>this.Hi*o?(Is()<=Ae.DEBUG&&oe("QueryEngine","The SDK decides to create cache indexes for query:",hi(n),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,zn(n))):H.resolve())}Yi(e,n){if(Zy(n))return H.resolve(null);let r=zn(n);return this.indexManager.getIndexType(e,r).next(o=>o===0?null:(n.limit!==null&&o===1&&(n=mh(n,null,"F"),r=zn(n)),this.indexManager.getDocumentsMatchingTarget(e,r).next(i=>{const s=Te(...i);return this.Ji.getDocuments(e,s).next(a=>this.indexManager.getMinOffset(e,r).next(l=>{const u=this.ts(n,a);return this.ns(n,u,s,l.readTime)?this.Yi(e,mh(n,null,"F")):this.rs(e,u,n,l)}))})))}Zi(e,n,r,o){return Zy(n)||o.isEqual(ye.min())?H.resolve(null):this.Ji.getDocuments(e,r).next(i=>{const s=this.ts(n,i);return this.ns(n,s,r,o)?H.resolve(null):(Is()<=Ae.DEBUG&&oe("QueryEngine","Re-using previous result from %s to execute query: %s",o.toString(),hi(n)),this.rs(e,s,n,m9(o,-1)).next(a=>a))})}ts(e,n){let r=new xt($1(e));return n.forEach((o,i)=>{nu(e,i)&&(r=r.add(i))}),r}ns(e,n,r,o){if(e.limit===null)return!1;if(r.size!==n.size)return!0;const i=e.limitType==="F"?n.last():n.first();return!!i&&(i.hasPendingWrites||i.version.compareTo(o)>0)}Xi(e,n,r){return Is()<=Ae.DEBUG&&oe("QueryEngine","Using full collection scan to execute query:",hi(n)),this.Ji.getDocumentsMatchingQuery(e,n,fo.min(),r)}rs(e,n,r,o){return this.Ji.getDocumentsMatchingQuery(e,r,o).next(i=>(n.forEach(s=>{i=i.insert(s.key,s)}),i))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function su(t){return new u3(t,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yN{constructor(){this.z_=void 0,this.j_=[]}H_(){return this.j_.some(e=>e.J_())}}class vN{constructor(){this.queries=mv(),this.onlineState="Unknown",this.Y_=new Set}terminate(){(function(n,r){const o=be(n),i=o.queries;o.queries=mv(),i.forEach((s,a)=>{for(const l of a.j_)l.onError(r)})})(this,new ce(z.ABORTED,"Firestore shutting down"))}}function mv(){return new ts(t=>M1(t),tu)}async function gw(t,e){const n=be(t);let r=3;const o=e.query;let i=n.queries.get(o);i?!i.H_()&&e.J_()&&(r=2):(i=new yN,r=e.J_()?0:1);try{switch(r){case 0:i.z_=await n.onListen(o,!0);break;case 1:i.z_=await n.onListen(o,!1);break;case 2:await n.onFirstRemoteStoreListen(o)}}catch(s){const a=tp(s,`Initialization of query '${hi(e.query)}' failed`);return void e.onError(a)}n.queries.set(o,i),i.j_.push(e),e.Z_(n.onlineState),i.z_&&e.X_(i.z_)&&np(n)}async function yw(t,e){const n=be(t),r=e.query;let o=3;const i=n.queries.get(r);if(i){const s=i.j_.indexOf(e);s>=0&&(i.j_.splice(s,1),i.j_.length===0?o=e.J_()?0:1:!i.H_()&&e.J_()&&(o=2))}switch(o){case 0:return n.queries.delete(r),n.onUnlisten(r,!0);case 1:return n.queries.delete(r),n.onUnlisten(r,!1);case 2:return n.onLastRemoteStoreUnlisten(r);default:return}}function bN(t,e){const n=be(t);let r=!1;for(const o of e){const i=o.query,s=n.queries.get(i);if(s){for(const a of s.j_)a.X_(o)&&(r=!0);s.z_=o}}r&&np(n)}function _N(t,e,n){const r=be(t),o=r.queries.get(e);if(o)for(const i of o.j_)i.onError(n);r.queries.delete(e)}function np(t){t.Y_.forEach(e=>{e.next()})}var wh,gv;(gv=wh||(wh={})).ea="default",gv.Cache="cache";class vw{constructor(e,n,r){this.query=e,this.ta=n,this.na=!1,this.ra=null,this.onlineState="Unknown",this.options=r||{}}X_(e){if(!this.options.includeMetadataChanges){const r=[];for(const o of e.docChanges)o.type!==3&&r.push(o);e=new Wi(e.query,e.docs,e.oldDocs,r,e.mutatedKeys,e.fromCache,e.syncStateChanged,!0,e.hasCachedResults)}let n=!1;return this.na?this.ia(e)&&(this.ta.next(e),n=!0):this.sa(e,this.onlineState)&&(this.oa(e),n=!0),this.ra=e,n}onError(e){this.ta.error(e)}Z_(e){this.onlineState=e;let n=!1;return this.ra&&!this.na&&this.sa(this.ra,e)&&(this.oa(this.ra),n=!0),n}sa(e,n){if(!e.fromCache||!this.J_())return!0;const r=n!=="Offline";return(!this.options._a||!r)&&(!e.docs.isEmpty()||e.hasCachedResults||n==="Offline")}ia(e){if(e.docChanges.length>0)return!0;const n=this.ra&&this.ra.hasPendingWrites!==e.hasPendingWrites;return!(!e.syncStateChanged&&!n)&&this.options.includeMetadataChanges===!0}oa(e){e=Wi.fromInitialDocuments(e.query,e.docs,e.mutatedKeys,e.fromCache,e.hasCachedResults),this.na=!0,this.ta.next(e)}J_(){return this.options.source!==wh.Cache}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class GN{constructor(){this.au=Promise.resolve(),this.uu=[],this.cu=!1,this.lu=[],this.hu=null,this.Pu=!1,this.Iu=!1,this.Tu=[],this.t_=new lw(this,"async_queue_retry"),this.Eu=()=>{const n=cd();n&&oe("AsyncQueue","Visibility state changed to "+n.visibilityState),this.t_.jo()};const e=cd();e&&typeof e.addEventListener=="function"&&e.addEventListener("visibilitychange",this.Eu)}get isShuttingDown(){return this.cu}enqueueAndForget(e){this.enqueue(e)}enqueueAndForgetEvenWhileRestricted(e){this.du(),this.Au(e)}enterRestrictedMode(e){if(!this.cu){this.cu=!0,this.Iu=e||!1;const n=cd();n&&typeof n.removeEventListener=="function"&&n.removeEventListener("visibilitychange",this.Eu)}}enqueue(e){if(this.du(),this.cu)return new Promise(()=>{});const n=new pr;return this.Au(()=>this.cu&&this.Iu?Promise.resolve():(e().then(n.resolve,n.reject),n.promise)).then(()=>n.promise)}enqueueRetryable(e){this.enqueueAndForget(()=>(this.uu.push(e),this.Ru()))}async Ru(){if(this.uu.length!==0){try{await this.uu[0](),this.uu.shift(),this.t_.reset()}catch(e){if(!za(e))throw e;oe("AsyncQueue","Operation failed with retryable error: "+e)}this.uu.length>0&&this.t_.Go(()=>this.Ru())}}Au(e){const n=this.au.then(()=>(this.Pu=!0,e().catch(r=>{this.hu=r,this.Pu=!1;const o=function(s){let a=s.message||"";return s.stack&&(a=s.stack.includes(s.message)?s.stack:s.message+`
`+s.stack),a}(r);throw _r("INTERNAL UNHANDLED ERROR: ",o),r}).then(r=>(this.Pu=!1,r))));return this.au=n,n}enqueueAfterDelay(e,n,r){this.du(),this.Tu.indexOf(e)>-1&&(n=0);const o=ep.createAndSchedule(this,e,n,r,i=>this.Vu(i));return this.lu.push(o),o}du(){this.hu&&me()}verifyOperationInProgress(){}async mu(){let e;do e=this.au,await e;while(e!==this.au)}fu(e){for(const n of this.lu)if(n.timerId===e)return!0;return!1}gu(e){return this.mu().then(()=>{this.lu.sort((n,r)=>n.targetTimeMs-r.targetTimeMs);for(const n of this.lu)if(n.skipDelay(),e!=="all"&&n.timerId===e)break;return this.mu()})}pu(e){this.Tu.push(e)}Vu(e){const n=this.lu.indexOf(e);this.lu.splice(n,1)}}class Ga extends cu{constructor(e,n,r,o){super(e,n,r,o),this.type="firestore",this._queue=function(){return new GN}(),this._persistenceKey=(o==null?void 0:o.name)||"[DEFAULT]"}_terminate(){return this._firestoreClient||Rw(this),this._firestoreClient.terminate()}}function QN(t,e){const n=typeof t=="object"?t:p0(),r=typeof t=="string"?t:"(default)",o=yf(n,"firestore").getImmediate({identifier:r});if(!o._initialized){const i=OP("firestore");i&&WN(o,...i)}return o}function ip(t){return t._firestoreClient||Rw(t),t._firestoreClient.verifyNotTerminated(),t._firestoreClient}function Rw(t){var e,n,r;const o=t._freezeSettings(),i=function(a,l,u,d){return new I9(a,l,u,d.host,d.ssl,d.experimentalForceLongPolling,d.experimentalAutoDetectLongPolling,kw(d.experimentalLongPollingOptions),d.useFetchStreams)}(t._databaseId,((e=t._app)===null||e===void 0?void 0:e.options.appId)||"",t._persistenceKey,o);t._firestoreClient=new FN(t._authCredentials,t._appCheckCredentials,t._queue,i),!((n=o.localCache)===null||n===void 0)&&n._offlineComponentProvider&&(!((r=o.localCache)===null||r===void 0)&&r._onlineComponentProvider)&&(t._firestoreClient._uninitializedComponentsProvider={_offlineKind:o.localCache.kind,_offline:o.localCache._offlineComponentProvider,_online:o.localCache._onlineComponentProvider})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ir(t){t=Er(t,Gt);const e=Er(t.firestore,Ga);return zN(ip(e),t._key).then(n=>dL(e,t,n))}class Bw extends iL{constructor(e){super(),this.firestore=e}convertBytes(e){return new qi(e)}convertReference(e){const n=this.convertDocumentKey(e,this.firestore._databaseId);return new Gt(this.firestore,null,n)}}function cL(t){t=Er(t,uu);const e=Er(t.firestore,Ga),n=ip(e),r=new Bw(e);return oL(t._query),HN(n,t._query).then(o=>new aL(e,r,t,o))}function uL(t,e,n){t=Er(t,Gt);const r=Er(t.firestore,Ga),o=sL(t.converter,e,n);return zw(r,[ZN(Vw(r),"setDoc",t._key,o,t.converter!==null,n).toMutation(t._key,Hn.none())])}function Th(t,e,n,...r){t=Er(t,Gt);const o=Er(t.firestore,Ga),i=Vw(o);let s;return s=typeof(e=Et(e))=="string"||e instanceof du?tL(i,"updateDoc",t._key,e,n,r):eL(i,"updateDoc",t._key,e),zw(o,[s.toMutation(t._key,Hn.exists(!0))])}function zw(t,e){return function(r,o){const i=new pr;return r.asyncQueue.enqueueAndForget(async()=>kN(await BN(r),o,i)),i.promise}(ip(t),e)}function dL(t,e,n){const r=n.docs.get(e._key),o=new Bw(t);return new jw(t,o,e._key,r,new Ns(n.hasPendingWrites,n.fromCache),e.converter)}(function(e,n=!0){(function(o){es=o})(Yi),Mi(new Wo("firestore",(r,{instanceIdentifier:o,options:i})=>{const s=r.getProvider("app").getImmediate(),a=new Ga(new l9(r.getProvider("auth-internal")),new h9(r.getProvider("app-check-internal")),function(u,d){if(!Object.prototype.hasOwnProperty.apply(u.options,["projectId"]))throw new ce(z.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Aa(u.options.projectId,d)}(s,o),s);return i=Object.assign({useFetchStreams:n},i),a._setSettings(i),a},"PUBLIC").setMultipleInstances(!0)),io(zy,"4.7.2",e),io(zy,"4.7.2","esm2017")})();const hL={apiKey:"AIzaSyA8jYL0_YD1f8lxP4Sv9RXbXckYcB3zUzw",authDomain:"mtc-database-7a3f4.firebaseapp.com",projectId:"mtc-database-7a3f4",storageBucket:"mtc-database-7a3f4.appspot.com",messagingSenderId:"210230014480",appId:"1:210230014480:web:a1d2942088a3e35accd095"},Hw=f0(hL),Ge=xf(Hw),ur=QN(Hw),Sv=navigator.onLine,Av="./src/model3/";let Po=!0,dd,_n,hd,fd,ui;const fL={data(){return{showPage:!0}},beforeMounted(){window.addEventListener("load",()=>{Sv||alert(`No network detected 
 ...
 Enter the last 4 digits of your matric number to login`,"0123")==u?a.data().verification=="verified"?(t.dispatch("anonSignin",a.data().name),Po=!1,_n.stop()):(Po=!1,_n.stop(),alert("User not verified! Contact Admin."),_e.push("/")):(Po=!1,_n.stop(),alert("Wrong User detected!"),_e.push("/"))}else console.log("Name does not exist")})}}e()},methods:{toggleShowProductPage(){_e.push("/"),Po=!1,this.showPage=!1},stopVid(){_n.stop(),Po=!1,this.showPage=!1}}},pL={class:"fixed outline-none flex flex-col bottom-0 h-full w-full bg-black z-40 bg-opacity-30 text-slate-800"},mL={class:"flex flex-col h-5/6 rounded-xl m-auto pt-2 pb-5 w-wd9 md:w-wd7 lg:w-wd45 xl:w-wd45 overflow-x-hidden overflow-y-auto overflow-hidden bg-slate-100 shadow-sm"},gL={class:"flex z-50 my-auto md:py-2 w-full h-full"},yL={class:"m-auto border-blue-400 flex-col py-10 px-4 space-y-10 md:space-y-5"},vL=P("div",{id:"webcam-container",class:"rounded-full w-fit h-fit -scroll-my-10 mx-auto overflow-hidden border-2 border-purple-700"},null,-1),bL={class:"flex w-full space-x-5 mx-auto"},_L=P("div",{id:"label-container",class:"rounded-xl text-sm md:text-base"},"Please wait while the system load...",-1),wL={class:"mx-auto text-center space-y-3"},EL=P("p",null,"Wrong Face detected?",-1),IL={class:"w-full flex justify-evenly md:justify-between mt-10 text-sm font-normal md:font-semibold border-red-500 md:mx-auto md:w-3/4"},TL=P("p",{class:"text-center my-auto"},"New to the system? Proceed to ",-1);function SL(t,e,n,r,o,i){const s=Ce("font-awesome-icon"),a=Ce("router-link");return B(),Ue(vo,{name:"slide-fade"},{default:Qe(()=>[at(P("div",pL,[P("div",{onClick:e[0]||(e[0]=l=>i.toggleShowProductPage()),class:"z-50 mx-auto mt-6 -mb-5 w-8 h-8 md:w-12 md:h-12 shadow-md cursor-pointer p-2 hover:bg-slate-300 transition-all rounded-full flex bg-gray-100"},[ue(s,{icon:"fa-solid fa-x",size:"sm",style:{color:"#333366"},class:"md:hidden m-auto rounded-full"}),ue(s,{icon:"fa-solid fa-x",size:"lg",style:{color:"#333366"},class:"hidden md:block m-auto rounded-full"})]),P("div",mL,[P("div",gL,[P("div",yL,[vL,P("div",bL,[_L,P("button",{type:"button",onClick:e[1]||(e[1]=l=>i.stopVid()),class:"rounded-lg px-4 py-0 shadow-md border-4 border-purple-900 bg-slate-200 text-sm md:text-base font-semibold"},"Stop Camera")])])]),P("div",wL,[EL,P("p",null,[ue(a,{to:"/manualLogin",onClick:e[2]||(e[2]=l=>i.stopVid()),class:"bg-purple-900 text-slate-200 px-6 py-1 hover:px-7 hover:py-2 rounded-lg transition-all shadow-lg"},{default:Qe(()=>[rt(" Manual LogIn")]),_:1})])]),P("div",IL,[TL,ue(a,{to:"/Signup",onClick:e[3]||(e[3]=l=>i.stopVid()),class:"bg-purple-900 text-slate-200 my-auto px-2 py-1 hover:px-7 hover:py-2 rounded-lg transition-all shadow-lg"},{default:Qe(()=>[rt(" Sign Up")]),_:1})])])],512),[[La,o.showPage]])]),_:1})}const AL=Jt(fL,[["render",SL]]),CL={components:{camPage:AL}};function xL(t,e,n,r,o,i){const s=Ce("camPage");return B(),te("div",null,[ue(s)])}const PL=Jt(CL,[["render",xL]]),kL={data(){return{showEye:!0,levelOptions:[{label:"ND 1",value:"nd1"},{label:"ND 2",value:"nd2"},{label:"HND 1",value:"hnd1"},{label:"HND 2",value:"hnd2"}],genderOptions:[{label:"Male",value:"male"},{label:"Female",value:"female"}]}},methods:{eyes(){this.showEye=!this.showEye}},setup(){const t=hr({}),e=Jo(),n=Fx(),r=hr(),o=[{label:"Computer Science",value:"computer science"},{label:"Science Laboratory Technology",value:"slt"},{label:"Engineering",value:"engineering"},{label:"Law",value:"law"},{label:"Tourism",value:"tourism"},{label:"Agriculture",value:"agriculture"},{label:"Pharmacy",value:"pharmacy"},{label:"Banking and Finance",value:"banking and finance"},{label:"Education",value:"education"},{label:"Mass Communication",value:"mass communication"},{label:"Business Administration",value:"Business Administration"},{label:"Food Technology",value:"food technology"},{label:"Glass Technology",value:"glass technology"},{label:"Accounting",value:"accounting"},{label:"Taxation",value:"taxation"},{label:"Fisheries",value:"fisheries"},{label:"Civil Engineering",value:"civil engineering"},{label:"Mechanical Engineering",value:"mechanical engineering"},{label:"Electrical Engineering",value:"electrical engineering"},{label:"Estate Management",value:"estate management"},{label:"Statistics",value:"statistics"},{label:"Art and industrial Design",value:"art and industrial design"},{label:"Marketing",value:"marketing"},{label:"Architectural Technology",value:"architectural technology"}],i=()=>{navigator.vibrate([100,50])};return{registerForm:t,showPassword:()=>{const l=document.getElementById("password"),u=document.getElementById("password2");l.type==="password"&&u.type==="password"?(l.type="text",u.type="text"):(l.type="password",u.type="password")},register:()=>{var l=document.getElementById("password"),u=document.getElementById("password2");l.value!=""&&u.value!=""&&(l.value===u.value?e.dispatch("register",t.value):(i(),n.add({severity:"error",summary:"Error!",detail:"Passwords not matched",life:3e3})))},departmentOptions:o,department:r}}},OL={class:"w-full h-full absolute flex"},RL={class:"h-fit m-auto px-2 flex flex-col-reverse rounded-lg md:flex-row w-11/12 md:w-2/3 py-10 bg-slate-50 shadow-2xl"},NL={class:"flex z-50 md:py-2 w-full h-full"},LL={class:"w-full h-full py-2 flex flex-col px-2 md:h-full m-auto md:m-0"},VL=P("img",{src:Zi,alt:"Fpa logo",class:"w-16 -mt-2 md:w-28 md:m-auto mx-auto"},null,-1),DL={class:"w-full h-full space-y-2 flex flex-col md:space-y-3"},ML=P("h2",{class:"text-slate-800 mx-auto font-bold text-lg uppercase"},"Sign up",-1),$L=P("h4",{class:"text-slate-800 font-bold text-sm md:text-base text-center"},"Enter your details below to signup.",-1),FL={class:"flex flex-col space-y-3 md:flex-col text-sm md:text-base"},UL=P("label",{for:"name",class:"bg-inherit mx-auto -yb-10 w-11/12 md:w-full lg:w-3/4 lg:mx-auto indent-1 font-bold"},"Enter Full Name:",-1),jL=P("label",{for:"DOB",class:"bg-inherit mx-auto -yb-10 w-11/12 md:w-full lg:w-3/4 lg:mx-auto indent-1 font-semibold"},"Date of Birth:",-1),BL=P("label",{for:"Email",class:"bg-inherit mx-auto -yb-10 w-11/12 md:w-full lg:w-3/4 lg:mx-auto indent-1 font-bold"},"Enter Email Address:",-1),zL=P("label",{for:"department",class:"bg-inherit m-auto py-2 w-11/12 md:w-full lg:w-3/4 lg:mx-auto indent-1 font-bold"},"Select Your Department.",-1),HL=["value"],KL=P("label",{for:"level",class:"bg-inherit mx-auto -yb-10 w-11/12 md:w-full lg:w-3/4 lg:mx-auto indent-1 font-bold"}," Select Your Level. ",-1),WL=["value"],qL=P("label",{for:"gender",class:"bg-inherit mx-auto -yb-10 w-11/12 md:w-full lg:w-3/4 lg:mx-auto indent-1 font-bold"},"Select Your Gender.",-1),GL=["value"],QL=P("label",{for:"matric",class:"bg-inherit mx-auto -yb-10 w-11/12 md:w-full lg:w-3/4 lg:mx-auto indent-1 font-bold"},"Enter Matric Number:",-1),YL=P("label",{for:"password",class:"bg-inherit mx-auto -yb-10 w-11/12 md:w-full lg:w-3/4 lg:mx-auto indent-1 font-bold"},"Enter Password:",-1),XL={class:"bg-inherit m-auto w-11/12 md:m-auto md:w-full lg:w-3/4 lg:m-auto border-b-2 flex border-slate-400"},JL=P("label",{for:"password",class:"bg-inherit mx-auto -mb-10 w-11/12 md:w-full lg:w-3/4 lg:mx-auto indent-1 font-bold"}," Confirm Password: ",-1),ZL=P("input",{id:"password2",type:"password",placeholder:"Confirm password",class:"bg-inherit m-auto text-xs md:text-sm py-2 w-11/12 md:w-full lg:w-3/4 lg:mx-auto indent-1 font-semibold border-b-2 border-slate-400"},null,-1),e5=P("input",{type:"submit",value:"submit",class:"bg-purple-900 font-bold text-slate-200 mx-auto w-fit px-6 py-1 hover:px-7 hover:py-2 rounded-lg transition-all shadow-lg"},null,-1),t5={class:"w-full flex justify-evenly md:justify-between mt-10 font-semibold border-red-500 md:mx-auto md:w-2/4"},n5=P("p",{class:"text-center text-sm md:text-base my-auto"},"Already verified? Proceed to ",-1);function r5(t,e,n,r,o,i){const s=Ce("font-awesome-icon"),a=Ce("router-link");return B(),te("div",OL,[P("div",RL,[P("div",NL,[P("div",LL,[VL,P("div",DL,[ML,$L,P("form",{name:"emailAndPassword",onSubmit:e[10]||(e[10]=af(l=>r.register(),["prevent"])),class:"flex flex-col space-y-3"},[P("div",FL,[UL,at(P("input",{name:"DisplayName",type:"text","onUpdate:modelValue":e[0]||(e[0]=l=>r.registerForm.name=l),placeholder:"Adigun Chibike Hassan",class:"bg-inherit m-auto py-2 w-11/12 md:w-full lg:w-3/4 lg:mx-auto indent-1 font-semibold border-b-2 border-slate-400"},null,512),[[rr,r.registerForm.name,void 0,{trim:!0,lazy:!0}]]),jL,at(P("input",{name:"Age",type:"date","onUpdate:modelValue":e[1]||(e[1]=l=>r.registerForm.age=l),class:"bg-inherit m-auto py-2 w-11/12 md:w-full lg:w-3/4 lg:mx-auto indent-1 font-semibold border-b-2 border-slate-400"},null,512),[[rr,r.registerForm.age,void 0,{trim:!0,lazy:!0}]]),BL,at(P("input",{name:"Email",type:"email","onUpdate:modelValue":e[2]||(e[2]=l=>r.registerForm.email=l),placeholder:"Johndeo@gmail.com",class:"bg-inherit m-auto py-2 w-11/12 md:w-full lg:w-3/4 lg:mx-auto indent-1 font-semibold border-b-2 border-slate-400"},null,512),[[rr,r.registerForm.email,void 0,{trim:!0,lazy:!0}]]),zL,at(P("select",{name:"department","onUpdate:modelValue":e[3]||(e[3]=l=>r.registerForm.department=l),class:"bg-inherit m-auto py-2 w-11/12 md:w-full lg:w-3/4 lg:mx-auto indent-1 font-semibold border-b-2 border-slate-400"},[(B(!0),te(He,null,Sn(r.departmentOptions,l=>(B(),te("option",{key:l.label,value:l.value},xe(l.label),9,HL))),128))],512),[[Bs,r.registerForm.department]]),KL,at(P("select",{name:"level","onUpdate:modelValue":e[4]||(e[4]=l=>r.registerForm.level=l),class:"bg-inherit m-auto py-2 w-11/12 md:w-full lg:w-3/4 lg:mx-auto indent-1 font-semibold border-b-2 border-slate-400"},[(B(!0),te(He,null,Sn(o.levelOptions,l=>(B(),te("option",{key:l.label,value:l.value},xe(l.label),9,WL))),128))],512),[[Bs,r.registerForm.level]]),qL,at(P("select",{name:"gender","onUpdate:modelValue":e[5]||(e[5]=l=>r.registerForm.gender=l),class:"bg-inherit m-auto py-2 w-11/12 md:w-full lg:w-3/4 lg:mx-auto indent-1 font-semibold border-b-2 border-slate-400"},[(B(!0),te(He,null,Sn(o.genderOptions,l=>(B(),te("option",{key:l.label,value:l.value},xe(l.label),9,GL))),128))],512),[[Bs,r.registerForm.gender]]),QL,at(P("input",{name:"matric",type:"text","onUpdate:modelValue":e[6]||(e[6]=l=>r.registerForm.matric=l),placeholder:"fpa/cs/19/2-0000",class:"bg-inherit m-auto py-2 w-11/12 md:w-full lg:w-3/4 lg:mx-auto indent-1 font-semibold border-b-2 border-slate-400"},null,512),[[rr,r.registerForm.matric,void 0,{trim:!0,lazy:!0}]]),YL,P("div",XL,[at(P("input",{id:"password",type:"password","onUpdate:modelValue":e[7]||(e[7]=l=>r.registerForm.password=l),class:"bg-inherit m-auto py-2 w-11/12 indent-1 font-semibold"},null,512),[[rr,r.registerForm.password,void 0,{trim:!0,lazy:!0}]]),o.showEye?(B(),Ue(s,{key:0,icon:"fa-solid fa-eye",onClick:e[8]||(e[8]=l=>(r.showPassword(),i.eyes())),class:"p-1 m-auto md:p-2 -mr-0 text-gray-600 border-2 rounded-md border-slate-400"})):(B(),Ue(s,{key:1,icon:"fa-solid fa-eye-slash",onClick:e[9]||(e[9]=l=>(r.showPassword(),i.eyes())),class:"p-1 m-auto md:p-2 -mr-0 text-gray-600 border-2 rounded-md border-slate-400"}))]),JL,ZL]),e5],32)]),P("div",t5,[n5,ue(a,{to:"/login",class:"bg-purple-900 text-slate-200 px-2 py-1 hover:px-7 hover:py-2 rounded-lg transition-all shadow-lg"},{default:Qe(()=>[rt(" Log In")]),_:1})])])])])])}const o5=Jt(kL,[["render",r5]]),i5={data(){return{userName:"waiting..."}},beforeMount(){this.fetchUserName()},methods:{logout(){this.$store.dispatch("logOut")},fetchUserName(){const t=Jo();Ge.onAuthStateChanged(e=>{e&&(t.state.user==null?this.userName=localStorage.getItem("user"):this.userName=t.state.user)})}}},s5={class:"flex justify-between text-xs mt-2 font-semibold bg-slate-200 border-red-500 px-1 md:px-4 md:w-wd8 md:mx-auto md:py-2 md:text-base rounded-lg"},a5={class:"flex justify-between py-2 w-full text-center h-fit border-blue-500 my-auto"},l5={class:"bg-purple-500 rounded-lg p-2 md:px-4 mx-1 shadow-lg"},c5={class:"font-bold"};function u5(t,e,n,r,o,i){return B(),te("div",s5,[P("div",a5,[P("p",l5,[rt("User: "),P("span",c5,xe(o.userName),1),rt(".")]),P("p",{class:"bg-purple-500 rounded-lg p-2 md:px-4 mx-1 shadow-lg cursor-pointer",onClick:e[0]||(e[0]=s=>i.logout())}," Logout")])])}const pu=Jt(i5,[["render",u5]]),d5={components:{headerComponent:pu},data(){return{userName:""}},mounted(){Ge.onAuthStateChanged(t=>{t&&(this.$store.state.user==null?this.userName=localStorage.getItem("user"):this.$store.state.user=="admin"?_e.push("/admin"):this.userName=this.$store.state.user)})}},h5={class:"w-full h-full absolute flex flex-col border-red-500"},f5={class:"flex flex-col h-5/6 rounded-xl m-auto pt-2 pb-5 w-wd9 md:w-wd7 lg:w-wd45 xl:w-wd45 bg-slate-100 shadow-sm"},p5={class:"flex z-50 my-auto md:py-2 w-full h-full"},m5={class:"w-full h-fit py-2 flex flex-col px-2 m-auto space-y-10"},g5=P("img",{src:Zi,alt:"Fpa logo",class:"w-16 -mt-2 md:w-28 my-auto mx-auto"},null,-1),y5={class:"w-full space-y-2 flex flex-col"},v5={class:"text-slate-800 mx-auto font-bold text-lg md:text-2xl"},b5=P("h4",{class:"text-slate-800 font-bold text-xs md:text-lg text-center"},"Choose an option below to take the exam or check you score.",-1),_5={class:"w-full flex justify-evenly md:justify-between font-semibold border-red-500 md:mx-auto md:w-2/4"};function w5(t,e,n,r,o,i){const s=Ce("header-component"),a=Ce("router-link");return B(),te("div",h5,[ue(s),P("div",f5,[P("div",p5,[P("div",m5,[g5,P("div",y5,[P("h2",v5,"Welcome "+xe(o.userName),1),b5]),P("div",_5,[ue(a,{to:"/examPage",class:"bg-purple-900 text-slate-200 px-2 py-1 hover:px-7 hover:py-2 rounded-lg transition-all shadow-lg"},{default:Qe(()=>[rt(" Start Exam")]),_:1}),ue(a,{to:"/scorePage",class:"bg-purple-900 text-slate-200 px-2 py-1 hover:px-7 hover:py-2 rounded-lg transition-all shadow-lg"},{default:Qe(()=>[rt(" Check Score")]),_:1})])])])])])}const E5=Jt(d5,[["render",w5]]);var I5=(t,e)=>{const n=t.__vccOpts||t;for(const[r,o]of e)n[r]=o;return n};const T5={name:"FulfillingBouncingCircleSpinner",props:{animationDuration:{type:Number,default:4e3},size:{type:Number,default:60},color:{type:String,default:"#fff"}},computed:{spinnerStyle(){return{height:`${this.size}px`,width:`${this.size}px`,animationDuration:`${this.animationDuration}ms`}},orbitStyle(){return{height:`${this.size}px`,width:`${this.size}px`,borderColor:this.color,borderWidth:`${this.size*.03}px`,animationDuration:`${this.animationDuration}ms`}},circleStyle(){return{height:`${this.size}px`,width:`${this.size}px`,borderColor:this.color,color:this.color,borderWidth:`${this.size*.1}px`,animationDuration:`${this.animationDuration}ms`}}}};function S5(t,e,n,r,o,i){return B(),te("div",{class:"fulfilling-bouncing-circle-spinner",style:Fo(i.spinnerStyle)},[P("div",{class:"circle",style:Fo(i.circleStyle)},null,4),P("div",{class:"orbit",style:Fo(i.orbitStyle)},null,4)],4)}var A5=I5(T5,[["render",S5]]);const C5={components:{FulfillingBouncingCircleSpinner:A5,headerComponent:pu},computed:{formattedTime(){const t=Math.floor(this.time/60),e=this.time%60;return`${t.toString().padStart(2,"0")}:${e.toString().padStart(2,"0")}`}},data(){return{time:600,selectedAnswers:{},answers:[]}},mounted(){this.startTimer()},beforeUnmounted(){this.stopTimer()},methods:{startTimer(){this.timer=setInterval(()=>{this.time>0?this.time--:(this.stopTimer(),this.handleTimerEnd())},1e3)},stopTimer(){clearInterval(this.timer),this.timer=null},handleTimerEnd(){_e.push("/scorePage")},submit(){if(confirm("Are you ready to submit answers?")){for(const[t,e]of Object.entries(this.selectedAnswers))this.answers.push(e);this.$store.dispatch("submitQuiz",this.answers),this.selectedAnswers={},this.answers=[],_e.push("/confirmScore")}else return}}},x5={class:"w-fit border-red-500 mx-auto"},P5={class:"bg-slate-200 flex justify-between my-2 border-black px-2 md:px-8 md:w-wd8 md:mx-auto md:text-base rounded-lg"},k5=P("h2",{class:"py-2 text-base font-semibold md:text-2xl my-auto"},"Course Code: GNS 501",-1),O5={class:"cursor-pointer bg-cyan-600 rounded-xl space-x-2 w-fit text-center flex px-2 md:px-4 py-2 my-2 text-xs font-semibold shadow-lg md:text-base"},R5={class:"py-1"},N5={class:"mx-auto"},L5={class:"w-98 flex flex-col mt-5 mb-10 text-xs md:lg capitalize rounded-xl shadow-black shadow-lg -shadow-lg"},V5=P("div",{class:"text-lg font-bold text-center underline py-2"},"Answer the following questions",-1),D5={class:"h-fitm px-2 md:px-10 w-full flex flex-wrap border-red-500"},M5={class:"text-base font-bold md:text-lg"},$5=["name","onUpdate:modelValue","value"],F5={for:"options",class:"my-auto ml-2 text-base"};function U5(t,e,n,r,o,i){const s=Ce("header-component"),a=Ce("fulfilling-bouncing-circle-spinner");return B(),te("div",x5,[ue(s),P("div",P5,[k5,P("div",O5,[ue(a,{class:"m-auto block md:hidden","animation-duration":4e3,size:15,color:"#ff1d5e"}),ue(a,{class:"m-auto hidden md:block","animation-duration":4e3,size:20,color:"#ff1d5e"}),P("p",R5,"Time : "+xe(i.formattedTime),1)])]),P("div",N5,[P("div",L5,[V5,P("div",D5,[(B(!0),te(He,null,Sn(this.$store.state.questions,(l,u)=>(B(),te("div",{key:u,class:"my-3 h-fit w-1/2 lg:w-1/3 border-red-500"},[P("h3",M5,"("+xe(u+1)+") "+xe(l.questionDetails.question),1),(B(!0),te(He,null,Sn(l.questionDetails.options,d=>(B(),te("div",{key:d,class:"my-2 ml-5 flex"},[at(P("input",{type:"radio",name:l.questionDetails.name,"onUpdate:modelValue":f=>o.selectedAnswers[l.questionDetails.name]=f,value:d,id:"",required:""},null,8,$5),[[AA,o.selectedAnswers[l.questionDetails.name]]]),P("label",F5,xe(d),1)]))),128))]))),128))]),P("button",{onClick:e[0]||(e[0]=l=>i.submit()),class:"w-11/12 my-4 mx-auto text-base md:text-lg font-bold bg-purple-900 py-5 text-slate-200 md:w-3/4 md:mx-auto rounded-xl shadow-lg"},"Submit")])])])}const j5=Jt(C5,[["render",U5]]),B5={components:{headerComponent:pu},data(){return{userName:"",score:"No score yet."}},beforeMount(){this.fetchData()},methods:{async fetchData(){if(this.$store.state.user==null){this.userName=localStorage.getItem("user");const t=eo(ur,"users",this.userName);await ir(t).then(e=>{e.exists()?this.score=e.data().score:this.score="No score yet. Take Exam."})}else{this.userName=this.$store.state.user;const t=eo(ur,"users",this.userName);await ir(t).then(e=>{e.exists()?this.score=e.data().score:this.score="No score yet. Go back and take the test."})}}}},z5={class:"w-full h-full absolute flex flex-col"},H5={class:"flex flex-col h-5/6 rounded-xl m-auto pt-2 pb-5 w-wd9 md:w-wd7 lg:w-wd45 xl:w-wd45 bg-slate-100 shadow-sm"},K5={class:"flex z-50 my-auto md:py-2 w-full h-full"},W5={class:"w-full h-fit py-2 flex flex-col px-2 m-auto space-y-10"},q5=P("img",{src:Zi,alt:"Fpa logo",class:"w-16 -mt-2 md:w-28 my-auto mx-auto"},null,-1),G5={class:"w-full space-y-2 flex flex-col"},Q5={class:"text-slate-800 mx-auto font-bold text-lg md:text-2xl"},Y5={class:"text-slate-800 font-bold text-xs md:text-lg text-center"},X5={class:"bg-purple-900 text-slate-200 px-2 py-1 rounded-lg transition-all shadow-lg"},J5={class:"w-full flex justify-evenly md:justify-between font-semibold border-red-500 md:mx-auto md:w-2/4"};function Z5(t,e,n,r,o,i){const s=Ce("header-component"),a=Ce("router-link");return B(),te("div",z5,[ue(s),P("div",H5,[P("div",K5,[P("div",W5,[q5,P("div",G5,[P("h2",Q5,"Welcome "+xe(o.userName),1),P("h4",Y5,[rt("Your Total Score is: "),P("span",X5,xe(o.score),1)])]),P("div",J5,[ue(a,{to:"/home",class:"bg-purple-900 text-slate-200 mx-auto px-2 py-1 hover:px-7 hover:py-2 rounded-lg transition-all shadow-lg"},{default:Qe(()=>[rt("Go Back")]),_:1})])])])])])}const eV=Jt(B5,[["render",Z5]]),tV={data(){return{timer:20}},mounted(){setInterval(()=>{this.timer=this.timer-1},1e3),setTimeout(()=>{this.$store.dispatch("logOut"),_e.push("/")},21e3)},unmounted(){clearInterval(),clearTimeout()},setup(){let t=!0;const e=Jo();return{toggleShowProductPage:()=>{e.dispatch("logOut"),_e.push("/")},showPage:t}}},Qa=t=>(Vb("data-v-3400db96"),t=t(),Db(),t),nV={class:"fixed outline-none flex flex-col bottom-0 h-full w-full bg-black z-40 bg-opacity-30 text-slate-800"},rV={class:"flex flex-col h-5/6 rounded-xl m-auto pt-2 pb-5 w-wd9 md:w-wd7 lg:w-wd45 xl:w-wd45 overflow-x-hidden overflow-y-auto overflow-hidden bg-slate-100 shadow-sm"},oV={class:"flex z-50 my-auto md:py-2 w-full h-full"},iV={class:"m-auto flex flex-col space-y-2 md:space-y-5"},sV=Qa(()=>P("div",{class:"md:hidden"},[P("svg",{class:"checkmark m-auto",xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 52 52"},[P("circle",{class:"checkmark__circle",cx:"26",cy:"26",r:"25",fill:"none"}),P("path",{class:"checkmark__check",fill:"none",d:"M14.1 27.2l7.1 7.2 16.7-16.8"})])],-1)),aV=Qa(()=>P("div",{class:"animation-ctn m-auto hidden md:flex"},[P("div",{class:"icon icon--order-success svg"},[P("svg",{xmlns:"http://www.w3.org/2000/svg",width:"154px",height:"154px"},[P("g",{fill:"none",stroke:"#22AE73","stroke-width":"2"},[P("circle",{cx:"77",cy:"77",r:"72",style:{"stroke-dasharray":"480px, 480px","stroke-dashoffset":"960px"}}),P("circle",{id:"colored",fill:"#22AE73",cx:"77",cy:"77",r:"72",style:{"stroke-dasharray":"480px, 480px","stroke-dashoffset":"960px"}}),P("polyline",{class:"st0",stroke:"#fff","stroke-width":"10",points:"43.5,77.8 63.7,97.9 112.2,49.4 ",style:{"stroke-dasharray":"100px, 100px","stroke-dashoffset":"200px"}})])])])],-1)),lV=Qa(()=>P("h2",{class:"font-bold text-base mx-auto md:text-lg"},"Details Registered Successfully!",-1)),cV={class:"mt-10 mx-auto text-blue-500 font-semibold underline"},uV={class:"font-semibold text-base text-center"},dV=Qa(()=>P("br",null,null,-1)),hV=Qa(()=>P("br",null,null,-1)),fV={class:"font-extrabold text-lg"};function pV(t,e,n,r,o,i){const s=Ce("font-awesome-icon"),a=Ce("router-link");return B(),Ue(vo,{name:"slide-fade"},{default:Qe(()=>[at(P("div",nV,[P("div",{onClick:e[0]||(e[0]=l=>r.toggleShowProductPage()),class:"z-50 mx-auto mt-6 -mb-5 w-8 h-8 md:w-12 md:h-12 shadow-md cursor-pointer p-2 hover:bg-slate-300 transition-all rounded-full flex bg-gray-100"},[ue(s,{icon:"fa-solid fa-x",size:"sm",style:{color:"#333366"},class:"md:hidden m-auto rounded-full"}),ue(s,{icon:"fa-solid fa-x",size:"lg",style:{color:"#333366"},class:"hidden md:block m-auto rounded-full"})]),P("div",rV,[P("div",oV,[P("div",iV,[sV,aV,lV,P("div",cV,[ue(a,{to:"/",onClick:e[1]||(e[1]=l=>r.toggleShowProductPage())},{default:Qe(()=>[rt(" Go to Home Page.")]),_:1})]),P("h1",uV,[rt(" Await further instructions for face capturing to complete registration. "),dV,hV,rt(" You will be rediected to Home Page in : "),P("span",fV,xe(o.timer),1),rt(" seconds. ")])])])])],512),[[La,r.showPage]])]),_:1})}const mV=Jt(tV,[["render",pV],["__scopeId","data-v-3400db96"]]),gV={data(){return{timer:20}},mounted(){setInterval(()=>{this.timer=this.timer-1},1e3),setTimeout(()=>{_e.push("/home")},21e3)},unmounted(){clearInterval(),clearTimeout()},setup(){return{toggleShowProductPage:()=>{_e.push("/home")},showPage:!0}}},mu=t=>(Vb("data-v-3ef70819"),t=t(),Db(),t),yV={class:"fixed outline-none flex flex-col bottom-0 h-full w-full bg-black z-40 bg-opacity-30 text-slate-800"},vV={class:"flex flex-col h-5/6 rounded-xl m-auto pt-2 pb-5 w-wd9 md:w-wd7 lg:w-wd45 xl:w-wd45 overflow-x-hidden overflow-y-auto overflow-hidden bg-slate-100 shadow-sm"},bV={class:"flex z-50 my-auto md:py-2 w-full h-full"},_V={class:"m-auto flex flex-col space-y-2 md:space-y-5"},wV=mu(()=>P("div",{class:"md:hidden"},[P("svg",{class:"checkmark m-auto",xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 52 52"},[P("circle",{class:"checkmark__circle",cx:"26",cy:"26",r:"25",fill:"none"}),P("path",{class:"checkmark__check",fill:"none",d:"M14.1 27.2l7.1 7.2 16.7-16.8"})])],-1)),EV=mu(()=>P("div",{class:"animation-ctn m-auto hidden md:flex"},[P("div",{class:"icon icon--order-success svg"},[P("svg",{xmlns:"http://www.w3.org/2000/svg",width:"154px",height:"154px"},[P("g",{fill:"none",stroke:"#22AE73","stroke-width":"2"},[P("circle",{cx:"77",cy:"77",r:"72",style:{"stroke-dasharray":"480px, 480px","stroke-dashoffset":"960px"}}),P("circle",{id:"colored",fill:"#22AE73",cx:"77",cy:"77",r:"72",style:{"stroke-dasharray":"480px, 480px","stroke-dashoffset":"960px"}}),P("polyline",{class:"st0",stroke:"#fff","stroke-width":"10",points:"43.5,77.8 63.7,97.9 112.2,49.4 ",style:{"stroke-dasharray":"100px, 100px","stroke-dashoffset":"200px"}})])])])],-1)),IV=mu(()=>P("h2",{class:"font-bold text-base mx-auto md:text-lg"},"Done!",-1)),TV=mu(()=>P("h1",{class:"font-semibold text-base text-center"}," Your score has been recorded successfully!",-1)),SV={class:"mt-10 mx-auto text-blue-500 font-semibold underline"},AV={class:"text-center"},CV={class:"font-extrabold text-lg"};function xV(t,e,n,r,o,i){const s=Ce("font-awesome-icon"),a=Ce("router-link");return B(),Ue(vo,{name:"slide-fade"},{default:Qe(()=>[at(P("div",yV,[P("div",{onClick:e[0]||(e[0]=l=>r.toggleShowProductPage()),class:"z-50 mx-auto mt-6 -mb-5 w-8 h-8 md:w-12 md:h-12 shadow-md cursor-pointer p-2 hover:bg-slate-300 transition-all rounded-full flex bg-gray-100"},[ue(s,{icon:"fa-solid fa-x",size:"sm",style:{color:"#333366"},class:"md:hidden m-auto rounded-full"}),ue(s,{icon:"fa-solid fa-x",size:"lg",style:{color:"#333366"},class:"hidden md:block m-auto rounded-full"})]),P("div",vV,[P("div",bV,[P("div",_V,[wV,EV,IV,TV,P("div",SV,[ue(a,{to:"/scorePage"},{default:Qe(()=>[rt(" View Your Score.")]),_:1})]),P("h2",AV,[rt(" You will be rediected to back Home in :"),P("span",CV,xe(o.timer),1),rt(" seconds. ")])])])])],512),[[La,r.showPage]])]),_:1})}const PV=Jt(gV,[["render",xV],["__scopeId","data-v-3ef70819"]]),kV={data(){return{showEye:!0}},methods:{eyes(){this.showEye=!this.showEye}},setup(){let t=!0;const e=Jo(),n=hr({});return{toggleShowProductPage:()=>{_e.push("/")},login:()=>{e.dispatch("login",n.value)},registerForm:n,showPassword:()=>{const s=document.getElementById("password");s.type==="password"?s.type="text":s.type="password"},showPage:t}}},OV={class:"fixed outline-none flex flex-col bottom-0 h-full w-full bg-black z-40 bg-opacity-30 text-slate-800"},RV={class:"flex flex-col h-5/6 rounded-xl m-auto pt-2 pb-5 w-wd9 md:w-wd7 lg:w-wd45 xl:w-wd45 overflow-x-hidden overflow-y-auto overflow-hidden bg-slate-100 shadow-sm"},NV={class:"flex z-50 my-auto md:py-2 w-full h-full"},LV={class:"w-full h-fit py-2 flex flex-col px-2 md:h-full m-auto md:m-0"},VV=P("img",{src:Zi,alt:"Fpa logo",class:"w-16 -mt-2 md:w-28 md:m-auto mx-auto"},null,-1),DV={class:"w-full h-full space-y-2 flex flex-col md:space-y-3"},MV=P("h2",{class:"text-slate-800 mx-auto font-bold text-lg"},"Login",-1),$V=P("h4",{class:"text-slate-800 font-bold text-xs text-center"},"Enter your details below to Login.",-1),FV={class:"flex flex-col space-y-3 md:flex-col text-xs md:text-sm"},UV=P("label",{for:"Email",class:"bg-inherit mx-auto -yb-10 w-11/12 md:w-full lg:w-3/4 lg:mx-auto indent-1 font-bold"},"Enter Email Address:",-1),jV=P("label",{for:"password",class:"bg-inherit mx-auto -yb-10 w-11/12 md:w-full lg:w-3/4 lg:mx-auto indent-1 font-bold"},"Enter Password:",-1),BV={class:"bg-inherit m-auto w-11/12 md:m-auto md:w-full lg:w-3/4 lg:m-auto border-b-2 flex border-slate-400"},zV=P("input",{type:"submit",value:"Login",class:"bg-purple-900 font-bold text-slate-200 mx-auto w-fit px-6 py-1 hover:px-7 hover:py-2 rounded-lg transition-all shadow-lg"},null,-1),HV={class:"w-full flex justify-evenly md:justify-between mt-10 text-sm font-normal md:font-semibold border-red-500 md:mx-auto md:w-3/4"},KV=P("p",{class:"text-center my-auto"},"New to the system? Proceed to ",-1);function WV(t,e,n,r,o,i){const s=Ce("font-awesome-icon"),a=Ce("router-link");return B(),Ue(vo,{name:"slide-fade"},{default:Qe(()=>[at(P("div",OV,[P("div",{onClick:e[0]||(e[0]=l=>r.toggleShowProductPage()),class:"z-50 mx-auto mt-6 -mb-5 w-8 h-8 md:w-12 md:h-12 shadow-md cursor-pointer p-2 hover:bg-slate-300 transition-all rounded-full flex bg-gray-100"},[ue(s,{icon:"fa-solid fa-x",size:"sm",style:{color:"#333366"},class:"md:hidden m-auto rounded-full"}),ue(s,{icon:"fa-solid fa-x",size:"lg",style:{color:"#333366"},class:"hidden md:block m-auto rounded-full"})]),P("div",RV,[P("div",NV,[P("div",LV,[VV,P("div",DV,[MV,$V,P("form",{name:"emailAndPassword",onSubmit:e[5]||(e[5]=af(l=>r.login(),["prevent"])),class:"flex flex-col space-y-3"},[P("div",FV,[UV,at(P("input",{name:"Email",type:"email","onUpdate:modelValue":e[1]||(e[1]=l=>r.registerForm.email=l),placeholder:"Johndeo@gmail.com",class:"bg-inherit m-auto py-2 w-11/12 md:w-full lg:w-3/4 lg:mx-auto indent-1 font-semibold border-b-2 border-slate-400"},null,512),[[rr,r.registerForm.email,void 0,{trim:!0,lazy:!0}]]),jV,P("div",BV,[at(P("input",{id:"password",type:"password","onUpdate:modelValue":e[2]||(e[2]=l=>r.registerForm.password=l),class:"bg-inherit m-auto py-2 w-11/12 indent-1 font-semibold"},null,512),[[rr,r.registerForm.password,void 0,{trim:!0,lazy:!0}]]),o.showEye?(B(),Ue(s,{key:0,icon:"fa-solid fa-eye",onClick:e[3]||(e[3]=l=>(r.showPassword(),i.eyes())),class:"p-1 m-auto md:p-2 -mr-0 text-gray-600 border-2 rounded-md border-slate-400"})):(B(),Ue(s,{key:1,icon:"fa-solid fa-eye-slash",onClick:e[4]||(e[4]=l=>(r.showPassword(),i.eyes())),class:"p-1 m-auto md:p-2 -mr-0 text-gray-600 border-2 rounded-md border-slate-400"}))])]),zV],32)]),P("div",HV,[KV,ue(a,{to:"/Signup",onClick:e[6]||(e[6]=l=>t.stopVid()),class:"bg-purple-900 text-slate-200 my-auto px-2 py-1 hover:px-7 hover:py-2 rounded-lg transition-all shadow-lg"},{default:Qe(()=>[rt(" Sign Up")]),_:1})])])])])],512),[[La,r.showPage]])]),_:1})}const qV=Jt(kV,[["render",WV]]),GV={components:{headerComponent:pu},data(){return{userName:"",score:"No score yet. Go back and take the test.",documents:[],verification:""}},mounted(){this.getRoute()},methods:{async updateUser(){if(this.userName!=""&&this.verification!=""){const t=eo(ur,"users",this.userName);await ir(t).then(e=>{e.exists()&&Th(t,{verification:this.verification}).then(()=>{this.userName="",this.verification="",alert("User Verification Status Updated."),window.location.reload()}).catch(n=>{console.log(n)})})}else alert("Please select the user and verification status.")},getRoute(){const t=K6();console.log(t.name),this.$store.state.user!="admin"&&t.name=="admin"?(console.log("authenticate user not admin"),_e.push("/home")):localStorage.getItem("user")&&t.name=="admin"?(console.log("local storage user not admin"),_e.push("/home")):this.fetchData()},async fetchData(){try{(await cL(qN(ur,"users"))).forEach(e=>{this.documents.push({id:e.id,data:e.data()})}),console.log(this.documents)}catch(t){console.log(t)}}}},QV={class:"w-full h-fit absolute flex flex-col"},YV={class:"flex flex-col h-fit rounded-xl my-5 mx-auto pb-2 w-fit md:w-wd7 lg:w-wd8 xl:w-wd45 bg-slate-100 shadow-sm"},XV={class:"flex z-50 my-auto md:py-2 w-full h-full border-blue-500"},JV={class:"w-full h-full py-2 flex flex-col px-2 border-red-500 mx-auto space-y-10"},ZV={class:"w-full space-y-2 flex flex-col"},eD=P("h2",{class:"text-slate-800 mx-auto font-bold text-lg md:text-2xl uppercase"},"Admin Page.",-1),tD={class:""},nD=P("tr",{class:"border-black rounded-t-xl border-2 md:border-4 font-bold text-center text-sm md:text-lg uppercase"},[P("td",null,"Name"),P("td",null,"Email"),P("td",null,"Matric Number"),P("td",null,"Department"),P("td",null,"Level"),P("td",null,"Score"),P("td",null,"Verification")],-1),rD={class:"border-black border-2 md:border-4 w-fit uppercase py-2"},oD={class:"border-black border-2 md:border-4 w-fit lowercase"},iD={class:"border-black border-2 md:border-4 w-fit uppercase"},sD={class:"border-black border-2 md:border-4 w-fit uppercase"},aD={class:"border-black border-2 md:border-4 w-fit uppercase"},lD={class:"border-black border-2 md:border-4 w-fit uppercase"},cD={class:"border-black border-2 md:border-4 w-fit uppercase"},uD={class:"flex flex-col space-y-3"},dD=P("h4",{class:"text-slate-800 font-bold text-base md:text-lg text-center uppercase"},"User Verification.",-1),hD={class:"border-blue-500 flex w-full md:w-3/4 mx-auto"},fD={class:"flex flex-col border-black w-full mx-5"},pD=P("label",{for:"userName",class:"text-base font-bold md:text-lg md:font-bold"},"User Name:",-1),mD=["value"],gD={class:"flex flex-col border-black w-full"},yD=P("label",{for:"verification",class:"text-base font-bold md:text-lg md:font-bold"},"Verification Status:",-1),vD=P("option",{value:"verified",class:"bg-inherit indent-1 font-semibold border-b-2 border-slate-400"}," verified ",-1),bD=P("option",{value:"Unverified",class:"bg-inherit indent-1 font-semibold border-b-2 border-slate-400"}," Unverified ",-1),_D=[vD,bD],wD={class:"w-full flex justify-evenly md:justify-between font-semibold border-red-500 md:mx-auto md:w-2/4"};function ED(t,e,n,r,o,i){const s=Ce("header-component");return B(),te("div",QV,[ue(s),P("div",YV,[P("div",XV,[P("div",JV,[P("div",ZV,[eD,P("table",tD,[nD,(B(!0),te(He,null,Sn(o.documents,a=>(B(),te("tr",{key:a.id,class:"border-blue-500 border-2 md:border-4 text-xs md:text-base"},[P("td",rD,xe(a.data.name),1),P("td",oD,xe(a.data.email),1),P("td",iD,xe(a.data.matric),1),P("td",sD,xe(a.data.department),1),P("td",aD,xe(a.data.level),1),P("td",lD,xe(a.data.score),1),P("td",cD,xe(a.data.verification),1)]))),128))])]),P("div",uD,[dD,P("div",hD,[P("div",fD,[pD,at(P("select",{name:"userName",id:"username","onUpdate:modelValue":e[0]||(e[0]=a=>o.userName=a)},[(B(!0),te(He,null,Sn(o.documents,a=>(B(),te("option",{value:a.data.name,key:a.id,class:"bg-inherit m-auto py-2 w-11/12 md:w-full lg:w-3/4 lg:mx-auto indent-1 font-semibold border-b-2 border-slate-400"},xe(a.data.name),9,mD))),128))],512),[[Bs,o.userName]])]),P("div",gD,[yD,at(P("select",{name:"verification",id:"verification","onUpdate:modelValue":e[1]||(e[1]=a=>o.verification=a)},_D,512),[[Bs,o.verification]])])])]),P("div",wD,[P("button",{onClick:e[2]||(e[2]=a=>i.updateUser()),class:"bg-purple-900 text-slate-200 mx-auto px-2 py-1 hover:px-7 hover:py-2 rounded-lg transition-all shadow-lg"},"Submit Verification.")])])])])])}const ID=Jt(GV,[["render",ED]]),TD={data(){return{showEye:!0}},methods:{eyes(){this.showEye=!this.showEye}},setup(){let t=!0;const e=Jo(),n=hr({});return{toggleShowProductPage:()=>{_e.push("/")},login:()=>{e.dispatch("AdminLogin",n.value)},registerForm:n,showPassword:()=>{const s=document.getElementById("password");s.type==="password"?s.type="text":s.type="password"},showPage:t}}},SD={class:"fixed outline-none flex flex-col bottom-0 h-full w-full bg-black z-40 bg-opacity-30 text-slate-800"},AD={class:"flex flex-col h-5/6 rounded-xl m-auto pt-2 pb-5 w-wd9 md:w-wd7 lg:w-wd45 xl:w-wd45 overflow-x-hidden overflow-y-auto overflow-hidden bg-slate-100 shadow-sm"},CD={class:"flex z-50 my-auto md:py-2 w-full h-full"},xD={class:"w-full h-fit py-2 flex flex-col px-2 md:h-full m-auto md:m-0"},PD=P("img",{src:Zi,alt:"Fpa logo",class:"w-16 -mt-2 md:w-28 md:m-auto mx-auto"},null,-1),kD={class:"w-full h-full space-y-2 flex flex-col md:space-y-3"},OD=P("h2",{class:"text-slate-800 mx-auto font-bold text-lg"},"Admin Login.",-1),RD=P("h4",{class:"text-slate-800 font-bold text-xs text-center"},"Provide your details below to as Admin to Login.",-1),ND={class:"flex flex-col space-y-3 md:flex-col text-xs md:text-sm"},LD=P("label",{for:"Email",class:"bg-inherit mx-auto -yb-10 w-11/12 md:w-full lg:w-3/4 lg:mx-auto indent-1 font-bold"},"Enter Email Address:",-1),VD=P("label",{for:"password",class:"bg-inherit mx-auto -yb-10 w-11/12 md:w-full lg:w-3/4 lg:mx-auto indent-1 font-bold"},"Enter Password:",-1),DD={class:"bg-inherit m-auto w-11/12 md:m-auto md:w-full lg:w-3/4 lg:m-auto border-b-2 flex border-slate-400"},MD=P("input",{type:"submit",value:"Login",class:"bg-purple-900 font-bold text-slate-200 mx-auto w-fit px-6 py-1 hover:px-7 hover:py-2 rounded-lg transition-all shadow-lg"},null,-1);function $D(t,e,n,r,o,i){const s=Ce("font-awesome-icon");return B(),Ue(vo,{name:"slide-fade"},{default:Qe(()=>[at(P("div",SD,[P("div",{onClick:e[0]||(e[0]=a=>r.toggleShowProductPage()),class:"z-50 mx-auto mt-6 -mb-5 w-8 h-8 md:w-12 md:h-12 shadow-md cursor-pointer p-2 hover:bg-slate-300 transition-all rounded-full flex bg-gray-100"},[ue(s,{icon:"fa-solid fa-x",size:"sm",style:{color:"#333366"},class:"md:hidden m-auto rounded-full"}),ue(s,{icon:"fa-solid fa-x",size:"lg",style:{color:"#333366"},class:"hidden md:block m-auto rounded-full"})]),P("div",AD,[P("div",CD,[P("div",xD,[PD,P("div",kD,[OD,RD,P("form",{name:"emailAndPassword",onSubmit:e[5]||(e[5]=af(a=>r.login(),["prevent"])),class:"flex flex-col space-y-3"},[P("div",ND,[LD,at(P("input",{name:"Email",type:"email","onUpdate:modelValue":e[1]||(e[1]=a=>r.registerForm.email=a),placeholder:"Admin@gmail.com",class:"bg-inherit m-auto py-2 w-11/12 md:w-full lg:w-3/4 lg:mx-auto indent-1 font-semibold border-b-2 border-slate-400"},null,512),[[rr,r.registerForm.email,void 0,{trim:!0,lazy:!0}]]),VD,P("div",DD,[at(P("input",{id:"password",type:"password","onUpdate:modelValue":e[2]||(e[2]=a=>r.registerForm.password=a),class:"bg-inherit m-auto py-2 w-11/12 indent-1 font-semibold"},null,512),[[rr,r.registerForm.password,void 0,{trim:!0,lazy:!0}]]),o.showEye?(B(),Ue(s,{key:0,icon:"fa-solid fa-eye",onClick:e[3]||(e[3]=a=>(r.showPassword(),i.eyes())),class:"p-1 m-auto md:p-2 -mr-0 text-gray-600 border-2 rounded-md border-slate-400"})):(B(),Ue(s,{key:1,icon:"fa-solid fa-eye-slash",onClick:e[4]||(e[4]=a=>(r.showPassword(),i.eyes())),class:"p-1 m-auto md:p-2 -mr-0 text-gray-600 border-2 rounded-md border-slate-400"}))])]),MD],32)])])])])],512),[[La,r.showPage]])]),_:1})}const FD=Jt(TD,[["render",$D]]),_e=z6({history:y6("/FPA-E-EXAM"),routes:[{path:"/",name:"landingPage",component:r9},{path:"/adminLogin",name:"adminLogin",component:FD},{path:"/login",name:"login",component:PL},{path:"/signup",name:"signup",component:o5},{path:"/manualLogin",name:"manualLogin",component:qV},{path:"/confirmSignup",name:"confirmSignup",component:mV},{path:"/confirmScore",name:"confirmScore",component:PV,meta:{requiresAuth:!0}},{path:"/admin",name:"admin",component:ID,meta:{requiresAuth:!0}},{path:"/home",name:"home",component:E5,meta:{requiresAuth:!0}},{path:"/scorePage",name:"scorePage",component:eV,meta:{requiresAuth:!0}},{path:"/examPage",name:"examPage",component:j5,meta:{requiresAuth:!0}}]});Ge.onAuthStateChanged(t=>{if(!t)return _e.push("/");_e.beforeEach(async e=>{if(e.path=="/"&&Ge.currentUser||e.path=="/login"&&Ge.currentUser||e.path=="/adminLogin"&&Ge.currentUser||e.path=="/signup"&&Ge.currentUser)return _e.push(_e.currentRoute);if(e.path=="/admin"&&!Ge.currentUser||e.path=="/Home"&&!Ge.currentUser||e.path=="/scorePage"&&!Ge.currentUser||e.path=="/examPage"&&!Ge.currentUser||e.path=="/confirmScore"&&!Ge.currentUser)return _e.push("/")})});const UD={setup(){const t=Jo(),e=xf();Bb(()=>{t.dispatch("fetchUser")}),Mc(()=>{rR(e,n=>{n?(n.getIdToken().then(r=>{document.cookie=`session= ${r}; max-age= ${60*60*24}`}),eR(e,Sf)):_e.push("/")})})}};function jD(t,e,n,r,o,i){const s=Ce("router-view");return B(),te("div",null,[ue(s)])}const BD=Jt(UD,[["render",jD]]),zD=F4({state:{user:null,correctAnswer:0,userAnswer:[],overallScore:0,questions:[{questionDetails:{name:"Question1",question:"Add 1 + 1 =",options:["(A) 20","(B) 0","(C) 2","(D) 15"],answer:"(C) 2"}},{questionDetails:{name:"Question2",question:"What is your supervisor name?",options:["(A) Mrs Abiodun","(B) A.O Ajao","(C) Dr. Fele","(D) Ms Ogunji"],answer:"(A) Mrs Abiodun"}},{questionDetails:{name:"Question3",question:"What goes up and doesn't come down?",options:["(A) Ball","(B) Age","(C) Naira","(D) Plane"],answer:"(B) Age"}},{questionDetails:{name:"Question4",question:"What is the opposite of the light?",options:["(A) Indigo","(B) Yellow","(C) Brown","(D) Dark"],answer:"(D) Dark"}},{questionDetails:{name:"Question5",question:"Which is the smallest?",options:["(A) Atom","(B) Molecule","(C) Droplet","(D) Stream"],answer:"(A) Atom"}}]},mutations:{setUser(t,e){t.user=e},clearUser(t){t.user=null},calculateAnswers(t,e){t.userAnswer=e,console.log(t.userAnswer);for(let n=0;n<t.questions.length;n++)t.userAnswer[n]==t.questions[n].questionDetails.answer&&t.correctAnswer++;console.log("correct answer:"+t.correctAnswer),t.overallScore=t.correctAnswer/t.questions.length*100,console.log(t.overallScore+" / 100"),t.userAnswer=[],t.correctAnswer=0}},actions:{async submitQuiz({commit:t,state:e},n){if(t("calculateAnswers",n),e.user==null){console.log("Anon user = "+localStorage.getItem("user"));const r=eo(ur,"users",localStorage.getItem("user"));await ir(r).then(o=>{o.exists()&&(console.log("Anon user has data in Firebase"),console.log("User current score :"+o.data().score),Th(r,{score:e.overallScore}))}),await ir(r).then(o=>{o.exists()?console.log("Updated score: "+o.data().score):console.log("No data")})}else if(e.user!=null){console.log("currently logged in user = "+e.user);const r=eo(ur,"users",e.user);await ir(r).then(o=>{o.exists()?(console.log("User has data in Firebase"),console.log("User current score :"+o.data().score),Th(r,{score:e.overallScore})):console.log("No data")}),await ir(r).then(o=>{o.exists()?console.log("Updated score: "+o.data().score):console.log("No data")})}},async anonSignin({commit:t},e){try{await qO(Ge),t("setUser",e),localStorage.setItem("user",e),console.log(localStorage.getItem("user")),_e.push("/home")}catch(n){console.log(n)}},async AdminLogin({commit:t},e){const{email:n,password:r}=e;try{await py(Ge,n,r)}catch(o){console.log(o)}t("setUser",Ge.currentUser.displayName),_e.push("/admin")},async login({commit:t},e){const{email:n,password:r}=e;try{await py(Ge,n,r)}catch(i){switch(i.code){case"auth/invalid-email":alert("Invalid email");break;case"auth/user-disabled":alert("User disabled");break;case"auth/user-not-found":alert("User not found");break;case"auth/wrong-password":alert("Wrong password");break;case"auth/missing-password":alert("Missing password");break;case"auth/missing-email":alert("Missing email");break;case"auth/invalid-password":alert("Invalid password");break;case"auth/operation-not-allowed":alert("Operation not allowed");break;case"auth/network-request-failed":alert("Network request failed");break;case"auth/too-many-requests":alert("Too many requests");break;default:alert("Something went wrong");break}return}console.log(Ge.currentUser);const o=eo(ur,"users",Ge.currentUser.displayName);await ir(o).then(i=>{i.exists()&&(i.data().verification=="Unverified"?(alert("Face not yet captured"),navigator.vibrate([100,50,100]),t("clearUser"),Ge.signOut(Ge)):(t("setUser",Ge.currentUser.displayName),_e.push("/home")))})},async register({commit:t},e){const{email:n,password:r,name:o,matric:i,age:s,department:a,level:l,gender:u}=e;try{await XO(Ge,n,r)}catch(f){switch(f.code){case"auth/email-already-in-use":alert("Email already in use");break;case"auth/invalid-email":alert("Invalid email");break;case"auth/weak-password":alert("Weak password");break;case"auth/missing-password":alert("Missing password");break;case"auth/missing-email":alert("Missing email");break;case"auth/invalid-password":alert("Invalid password");break;case"auth/operation-not-allowed":alert("Operation not allowed");break;case"auth/network-request-failed":alert("Network request failed");break;case"auth/too-many-requests":alert("Too many requests");break;default:alert("Something went wrong");break}return}t("setUser",Ge.currentUser.displayName),_e.push("/confirmSignup");const d=xf().currentUser;ZO(d,{displayName:o,matricNumber:i,verification:"Unverified",age:s,score:0,department:a,level:l,gender:u}).then(()=>{console.log("User created successfully")}).catch(f=>{console.log(f)}),uL(eo(ur,"users",o),{email:n,name:o,matric:i,age:s,verification:"Unverified",score:0,department:a,level:l,gender:u},{merge:!0})},async logOut({commit:t}){t("clearUser"),localStorage.removeItem("user"),console.log(localStorage),await Ge.signOut(Ge),_e.push("/")},fetchUser({commit:t}){Ge.onAuthStateChanged(async e=>{e==null?_e.push(_e.currentRoute):(t("setUser",Ge.currentUser.displayName),_e.isReady()&&_e.currentRoute.value.path=="/"&&_e.push("/home"))})}}}),On=OA(BD);On.use(_e);On.use(zD);On.use(o2,{unstyled:!0});ZI.add(qA,WA,GA);On.use(Ux);On.component("font-awesome-icon",KA);On.component("Avatar",W_);On.component("Select",o0);On.component("InputText",pf);On.component("Toast",G_);On.component("Button",K_);On.mount("#app");
